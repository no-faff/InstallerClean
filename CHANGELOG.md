...
- The GUI settles on one word for the removable files: "unused". The opening explanation and the clean-up count had said "unneeded" while the window title, the size summaries and every automation name said "unused"; the copy now says "unused" throughout, and the intro's now-redundant "they sit unused" is reworded so the word does not appear twice in one sentence.
