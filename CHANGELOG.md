...
- The README now shows what people actually freed, rather than the smallest, the median and the largest. Those three answered almost nothing: what somebody wants to know before running this is how likely they are to get anything and roughly how much. It is a distribution now, seven bands with one bar per report, and the shape is the point: of the 85 people who freed anything, 45 cleared between 10 and 50 GB. The four largest are named too, 327, 228, 162 and 152 GB, in place of "a few cleared hundreds of GB". The reports are described as anonymous as well as optional in that same sentence, which is where a reader first learns the app sends anything at all.
...
- The first row of the reports table reads "Less than 1 GB" where it said "Under 1 GB", which now pairs with the "More than 100 GB" at the other end. The sixteen translations already said their own natural equivalent of "less than", so only the English moved.
