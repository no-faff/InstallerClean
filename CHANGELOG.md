...
- The all-clean and not-yet-scanned window states no longer float their content in the middle of the window. The content column sized itself to whatever it held and centred the result, which nothing could show while the move-location box always kept it at full width; once these states removed that box, the heading and the counts drifted to the centre while Re-scan and About stayed at the left margin. The column now holds its full width in every state.
