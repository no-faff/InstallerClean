...
/// do not exercise the mutex hold. <see cref="TryAcquire"/> always reports
/// "could not acquire, fall back", so a service built with it proceeds without
/// holding <c>Global\_MSIExecute</c> and never refuses on the mutex. Production
