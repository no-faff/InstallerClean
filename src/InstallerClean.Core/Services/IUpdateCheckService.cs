...
/// <summary>
/// Single-call version check against GitHub. Two call sites,
...
{
    /// <summary>
    /// Issues a single HTTPS GET for the project's "latest" release,
    /// reads the tag out of the answer, and compares it to the running
    /// assembly version. Returns one of three
    ...
    /// with no route to github.com is a normal machine, and the automatic
    /// check meets one at every launch.
    /// </param>
