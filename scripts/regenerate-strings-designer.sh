...
BEGIN {
    ...
    print "    /// Exposed because TranslateExtension reuses this same instance"
    print "    /// to resolve XAML keys; constructing a parallel ResourceManager"
    print "    /// from the WPF host assembly would miss the resx embedded in"
    print "    /// InstallerClean.Core."
    print "    /// </summary>"
