...
const MAP = {
  ...
  'Summary.NothingListed.Singular': `Di PC ini InstallerClean tidak bisa memastikan file mana dalam cache yang menjadi milik program-program yang terpasang di sini, jadi satu-satunya file itu ditahan dan tidak dicantumkan.`,
  'Summary.NothingListed.Plural': `Di PC ini InstallerClean tidak bisa memastikan file mana dalam cache yang menjadi milik program-program yang terpasang di sini, jadi {0} {1} ditahan dan tidak dicantumkan.`,
  ...
  'Summary.SupersededHeldBack.Singular': `Di PC ini InstallerClean tidak bisa memastikan bahwa satu-satunya file yang digantikan itu sudah tidak diperlukan, jadi file itu ditahan.`,
  'Summary.SupersededHeldBack.Plural': `Di PC ini InstallerClean tidak bisa memastikan bahwa {0} file yang digantikan sudah tidak diperlukan, jadi file-file itu ditahan.`,
  'Cli.SupersededHeldBack.Singular': `Di PC ini InstallerClean tidak bisa memastikan bahwa satu-satunya file yang digantikan itu sudah tidak diperlukan, jadi file itu ditahan.`,
  'Cli.SupersededHeldBack.Plural': `Di PC ini InstallerClean tidak bisa memastikan bahwa {0} file yang digantikan sudah tidak diperlukan, jadi file-file itu ditahan.`,
  'Completion.HeldBack.Singular': `{0} file ditahan. Pemindaian menyebutnya tidak diperlukan. Pemeriksaan akhir tidak sependapat.`,
  'Completion.HeldBack.Plural': `{0} file ditahan. Pemindaian menyebutnya tidak diperlukan. Pemeriksaan akhir tidak sependapat.`,
  ...
  'Cli.NothingListed.Singular': `Di PC ini InstallerClean tidak bisa memastikan file mana saja dalam cache yang menjadi milik program yang terpasang di sini, jadi satu file itu ({2}) ditahan dan tidak didaftarkan.`,
  'Cli.NothingListed.Plural': `Di PC ini InstallerClean tidak bisa memastikan file mana saja dalam cache yang menjadi milik program yang terpasang di sini, jadi {0} {1} ({2}) ditahan dan tidak didaftarkan.`,
  'Cli.WithheldReasons.Header': `Kenapa tidak bisa dipastikan:`,
  'Cli.WithheldReasons.RecordedPath': `  Sebuah jalur file dalam catatan Windows Installer sendiri tidak bisa diuraikan.`,
  'Cli.WithheldReasons.FileIdentity': `  Identitas sebuah file yang disebut dalam catatan Windows Installer tidak bisa dibaca.`,
  'Cli.WithheldReasons.SecondInstance': `  Sebuah program mungkin terpasang lebih dari sekali di PC ini.`,
