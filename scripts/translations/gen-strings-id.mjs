...
const MAP = {
  ...
  'Cli.NothingOffered.Singular': `InstallerClean tidak bisa memastikan file mana dalam singgahan yang menjadi milik program-program yang terpasang di sini, jadi satu-satunya file ({2}) yang mungkin ditawarkannya ditahan.`,
  'Cli.NothingOffered.Plural': `InstallerClean tidak bisa memastikan file mana dalam singgahan yang menjadi milik program-program yang terpasang di sini, jadi seluruh {0} {1} ({2}) yang mungkin ditawarkannya ditahan.`,
  ...
  'Completion.ReverifyOwnershipUnestablished': `{0} {1} dibiarkan di tempatnya, karena sampai pemeriksaan terakhir InstallerClean tidak bisa memastikan file mana dalam singgahan yang menjadi milik program-program yang terpasang di sini.`,
