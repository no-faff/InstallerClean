...
const MAP = {
  ...
  'Body.PendingReboot.MsiExecuteMutexAccessRefused': `Windows menolak izin InstallerClean untuk memeriksa apakah Windows Installer sedang sibuk, jadi Pindahkan dan Hapus dijeda dan InstallerClean tidak akan menyentuh {InstallerFolder}. Restart Windows lalu Pindai ulang. Kalau Windows tetap menolak, ini bukan komputer yang bisa dibersihkan InstallerClean.`,
  ...
  'Status.MoveFailed': `{0}. Detail di {1}.`,
  'Status.MoveFailed.NoLog': `{0}. Log kerusakan tidak bisa ditulis.`,
  'Status.DeleteFailed': `{0}. Detail di {1}.`,
  'Status.DeleteFailed.NoLog': `{0}. Log kerusakan tidak bisa ditulis.`,
  ...
  'Error.StoppedTitle': `InstallerClean berhenti`,
  ...
  'Error.MsiNonSuccess': `Windows Installer tidak bisa memberi InstallerClean daftar program terpasang yang terbaca: InstallerClean membaca {1} {2}, lalu satu entri kembali tidak terbaca (kode kesalahan {0}). Alih-alih bekerja dengan daftar yang hanya terbaca sebagian, InstallerClean berhenti. Tidak ada yang dihapus.`,
  ...
  'Completion.MoveCancelledSummary': `{0} dari {1} {2} dipindahkan ke {3} sebelum Anda membatalkan.`,
  ...
  'Error.ScanInstallerFolderElsewhere': `InstallerClean tidak bisa memindai {InstallerFolder} di PC ini. Windows melaporkan folder itu sebagai {0}, dan InstallerClean hanya memindai folder Installer yang dilaporkan Windows di jalurnya sendiri. Tidak ada yang ditawarkan dan tidak ada yang disingkirkan.`,
  ...
  'Cli.MoveInstallerLockAccessRefused': `Kesalahan: Windows menolak izin InstallerClean untuk memeriksa apakah Windows Installer sedang sibuk, jadi tidak bisa mengesampingkan bahwa sebuah file menjadi diperlukan di tengah jalan. Tidak ada yang dipindahkan.`,
  'Cli.PendingRebootBlocked.RegistryCheckUnreadable': `Kesalahan: InstallerClean tidak bisa membaca salah satu nilai registri yang diperiksanya sebelum menyentuh {InstallerFolder}, jadi tidak bisa mengesampingkan operasi Windows Installer yang sedang berjalan atau mengantre untuk restart berikutnya. /m dan /d diblokir. Restart Windows lalu coba lagi. Kalau pembacaannya tetap gagal, ini bukan komputer yang bisa dibersihkan InstallerClean.`,
  'Completion.MoveCancelledRestoreHint': `Mudah untuk dibatalkan. Pindahkan kembali ke {InstallerFolder} dan semuanya akan kembali seperti semula.`,
  'Error.InstallerLockAccessRefused': `Windows menolak izin InstallerClean untuk memeriksa apakah Windows Installer sedang sibuk, jadi tidak bisa mengesampingkan bahwa sebuah file menjadi diperlukan di tengah jalan, dan tidak ada yang dihapus.`,
  'Error.MoveInstallerLockAccessRefused': `Windows menolak izin InstallerClean untuk memeriksa apakah Windows Installer sedang sibuk, jadi tidak bisa mengesampingkan bahwa sebuah file menjadi diperlukan di tengah jalan, dan tidak ada yang dipindahkan.`,
  'Error.MoveStoppedTitle': `Pemindahan dihentikan`,
  'Field.NoNamedProduct': `(tanpa program)`,
