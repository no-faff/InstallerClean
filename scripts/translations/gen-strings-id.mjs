...
const MAP = {
  ...
  'Cli.Help.Help': `  installerclean-cli --help     Tampilkan bantuan ini (juga menerima /?, -h)`,
  'Cli.Help.Version': `  installerclean-cli --version  Cetak versi (juga menerima -v)`,
  'Cli.Help.ScanOnly': `  installerclean-cli /s         Pindai saja - daftar file tidak diperlukan`,
  'Cli.Help.Delete': `  installerclean-cli /d         Hapus file tidak diperlukan (Keranjang Sampah)`,
  ...
  'Cli.Help.ExitCodeError': `  1   gagal: tidak ada yang diproses (argumen salah, pemindaian gagal, semua file gagal)`,
  ...
  'Cli.Help.MoveScheduledNote': `Lokasi default tersimpan bersifat per-pengguna; tugas terjadwal atau proses SYSTEM memerlukan /m JALUR.`,
  ...
  'Automation.AutoUpdateCheck.HelpText': `Jika dicentang, InstallerClean memeriksa github apakah ada versi yang lebih baru saat Anda menjalankannya.`,
};
