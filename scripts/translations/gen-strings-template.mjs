...
const MAP = {
  ...
  'Section.Move.Location': `MOVE LOCATION`,
  ...
  'Summary.ProgramsUnreadable.Singular': `{0} installed program could not be read during this scan, so superseded patches have been kept. Orphaned files are not affected.`,
  'Summary.ProgramsUnreadable.Plural': `{0} installed programs could not be read during this scan, so superseded patches have been kept. Orphaned files are not affected.`,
  ...
  'Cli.Help.MoveScheduledNote': `The saved default is per-user; scheduled or SYSTEM runs need /m PATH.`,
