...
const MAP = {
  ...
  'Summary.NothingListedPerFile.Singular': `InstallerClean couldn't establish that one of the cached files it found is unneeded, so it has held back the one file rather than offering it.`,
  'Summary.NothingListedPerFile.Plural': `InstallerClean couldn't establish that some of the cached files it found are unneeded, so it has held back {0} {1} rather than offering them.`,
