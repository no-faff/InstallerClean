...
const MAP = {
  ...
  'Completion.HeldBack.Singular': `{0} file held back. The scan said it was unneeded. The final check couldn't confirm that.`,
  'Completion.HeldBack.Plural': `{0} files held back. The scan said these were unneeded. The final check couldn't confirm that.`,
  ...
  'Summary.NothingListed.Singular': `InstallerClean couldn't be certain which cached files belong to the programs installed here, so it has held back the one file rather than offering it.`,
  'Summary.NothingListed.Plural': `InstallerClean couldn't be certain which cached files belong to the programs installed here, so it has held back {0} {1} rather than offering them.`,
  'Summary.NothingListedPerFile.Singular': `InstallerClean couldn't be certain about one of the cached files it found, so it has held that one back rather than offering it.`,
  'Summary.NothingListedPerFile.Plural': `InstallerClean couldn't be certain about some of the cached files it found, so it has held back {0} {1} rather than offering them.`,
  'Summary.SupersededHeldBack.Singular': `InstallerClean couldn't be certain that the one superseded file is no longer needed, so it has held it back.`,
  'Summary.SupersededHeldBack.Plural': `InstallerClean couldn't be certain that {0} superseded files are no longer needed, so it has held them back.`,
  'Cli.SupersededHeldBack.Singular': `InstallerClean couldn't be certain that the one superseded file is no longer needed, so it has held it back.`,
  'Cli.SupersededHeldBack.Plural': `InstallerClean couldn't be certain that {0} superseded files are no longer needed, so it has held them back.`,
  ...
  'Error.StoppedTitle': `InstallerClean stopped`,
  ...
  'Error.MsiNonSuccess': `Windows Installer couldn't give InstallerClean a readable list of the installed programs: it read {1} {2}, then an entry came back unreadable (error code {0}). Rather than work from a part-read list, InstallerClean stopped. Nothing has been removed.`,
  ...
  'Error.ScanInstallerFolderElsewhere': `InstallerClean can't scan {InstallerFolder} on this PC. Windows reports that folder as {0}, and InstallerClean only scans an Installer folder that Windows reports at its own path. Nothing has been offered and nothing has been removed.`,
  ...
  'Error.DestinationWriteFailedTitle': `Couldn't use that backup folder`,
  ...
  'Completion.NothingOfferedPerFileBody.Singular': `InstallerClean couldn't establish that the cached file it found is unneeded, so it has held back the one file ({2}) rather than offering it.`,
  'Completion.NothingOfferedPerFileBody.Plural': `InstallerClean couldn't establish that any of the cached files it found are unneeded, so it has held back all {0} {1} ({2}) rather than offering them.`,
  ...
  'Cli.NothingOffered.Singular': `InstallerClean couldn't be certain which cached files belong to the programs installed here, so it has held back the one file ({2}) rather than offering it.`,
  'Cli.NothingOffered.Plural': `InstallerClean couldn't be certain which cached files belong to the programs installed here, so it has held back all {0} {1} ({2}) rather than offering them.`,
  ...
  'Cli.NothingListed.Singular': `InstallerClean couldn't be certain which cached files belong to the programs installed here, so it has held back the one file ({2}) rather than offering it.`,
  'Cli.NothingListed.Plural': `InstallerClean couldn't be certain which cached files belong to the programs installed here, so it has held back {0} {1} ({2}) rather than offering them.`,
  'Cli.NothingListedPerFile.Singular': `InstallerClean couldn't be certain about one of the cached files it found, so it has held that one back ({2}) rather than offering it.`,
  'Cli.NothingListedPerFile.Plural': `InstallerClean couldn't be certain about some of the cached files it found, so it has held back {0} {1} ({2}) rather than offering them.`,
  'Cli.WithheldReasons.Header': `Why it couldn't be certain:`,
  'Cli.WithheldReasons.RecordedPath': `  A file path in Windows Installer's own records wouldn't resolve, so nothing could be matched to it.`,
