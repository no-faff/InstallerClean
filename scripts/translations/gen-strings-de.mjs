...
const MAP = {
  ...
  'Summary.SupersededHeldBack.Singular': `Auf diesem PC konnte InstallerClean nicht sicher feststellen, dass die eine ersetzte Datei nicht mehr gebraucht wird, und hat sie deshalb zurückgehalten.`,
  'Summary.SupersededHeldBack.Plural': `Auf diesem PC konnte InstallerClean nicht sicher feststellen, dass {0} ersetzte Dateien nicht mehr gebraucht werden, und hat sie deshalb zurückgehalten.`,
  'Cli.SupersededHeldBack.Singular': `Auf diesem PC konnte InstallerClean nicht sicher feststellen, dass die eine ersetzte Datei nicht mehr gebraucht wird, und hat sie deshalb zurückgehalten.`,
  'Cli.SupersededHeldBack.Plural': `Auf diesem PC konnte InstallerClean nicht sicher feststellen, dass {0} ersetzte Dateien nicht mehr gebraucht werden, und hat sie deshalb zurückgehalten.`,
  'Completion.HeldBack.Singular': `{0} Datei zurückgehalten. Der Scan hielt sie für nicht benötigt. Die abschließende Prüfung sah das anders.`,
  'Completion.HeldBack.Plural': `{0} Dateien zurückgehalten. Der Scan hielt sie für nicht benötigt. Die abschließende Prüfung sah das anders.`,
  ...
  'Cli.NothingListed.Singular': `Auf diesem PC konnte InstallerClean nicht sicher feststellen, welche zwischengespeicherten Dateien zu den hier installierten Programmen gehören, und hat die eine Datei ({2}) deshalb zurückgehalten, statt sie aufzulisten.`,
  'Cli.NothingListed.Plural': `Auf diesem PC konnte InstallerClean nicht sicher feststellen, welche zwischengespeicherten Dateien zu den hier installierten Programmen gehören, und hat {0} {1} ({2}) deshalb zurückgehalten, statt sie aufzulisten.`,
  'Cli.WithheldReasons.Header': `Warum keine Gewissheit möglich war:`,
  'Cli.WithheldReasons.RecordedPath': `  Ein Dateipfad in den eigenen Aufzeichnungen von Windows Installer ließ sich nicht auflösen.`,
  'Cli.WithheldReasons.FileIdentity': `  Die Identität einer in den Aufzeichnungen von Windows Installer genannten Datei ließ sich nicht lesen.`,
  'Cli.WithheldReasons.SecondInstance': `  Ein Programm ist auf diesem PC möglicherweise mehrfach installiert.`,
