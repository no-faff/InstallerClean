...
const MAP = {
  ...
  'Section.Move.Location': `VERPLAATSLOCATIE`,
  ...
  'Action.MoveInstead': `In plaats daarvan _verplaatsen`,
  'Action.MoveDestinationPlaceholder': `Pad naar de map als je kiest voor Verplaatsen in plaats van Verwijderen`,
  ...
  'Automation.RecycleUnavailable': `Kies wat er met de overbodige bestanden moet gebeuren: verplaats ze naar een veilige plek, verwijder ze definitief of annuleer.`,
  'Automation.RecycleUnavailableMove': `De overbodige bestanden verplaatsen naar een map die je zelf kiest`,
  'Automation.RecycleUnavailableDeletePermanently': `De overbodige bestanden definitief verwijderen, omdat de Prullenbak voor deze schijf niet beschikbaar is`,
  ...
  'Automation.RegisteredMissingSeeAlso': `Legt in het README-bestand uit wat deze map is en hoe je een bestand terugzet`,
  ...
  'Status.CheckingRecycleBin': `Prullenbak controleren...`,
  ...
  'Completion.MoveRestoreHint': `Kopieer ze terug naar {InstallerFolder} als er ooit iets stukgaat ([uiterst onwaarschijnlijk]).`,
  'Completion.DeleteRestoreHint': `Tot die tijd kun je ze terugzetten als er ooit iets stukgaat ([uiterst onwaarschijnlijk]).`,
  'Completion.DeleteSpaceHint': `Leeg hem om de ruimte echt terug te krijgen.`,
  'Completion.Freed': `{0} vrijgemaakt`,
  'Completion.CleanedUp': `{0} opgeruimd`,
  ...
  'Completion.DeleteSummary.Singular': `{0} {1} naar de Prullenbak verplaatst`,
  'Completion.DeleteSummary.Plural': `{0} {1} naar de Prullenbak verplaatst`,
  ...
  'Completion.DeleteCancelledSummary': `{0} van {1} {2} naar de Prullenbak verplaatst voordat je annuleerde.`,
  ...
  'Confirm.DeleteToRecycleBin': `De bestanden gaan naar de Prullenbak. Wil je back-ups, gebruik dan de knop Verplaatsen.`,
  ...
  'Error.ShellRecycleFailed': `Kon dit bestand niet naar de Prullenbak verplaatsen (fout {0}), en aan die code kan InstallerClean niet zien waarom. Het bestand is blijven staan. Probeer de knop Verplaatsen; die gebruikt de Prullenbak niet.`,
  'Error.RecycleAccessDenied': `Windows weigerde de toegang, zelfs met administratorrechten (fout {0}), en InstallerClean kan niet zien of het aan het bestand of aan de Prullenbak ligt. Het bestand is blijven staan. De knop Verplaatsen werkt als het aan de Prullenbak ligt, maar niet als het aan het bestand ligt.`,
  'Error.RecycleInUse': `Dit bestand is geopend of vergrendeld door een ander programma (fout {0}), dus niets kan het nu weghalen. Het is blijven staan; probeer het later opnieuw.`,
  'Error.DeletedNotRecycled': `Windows heeft dit bestand meteen definitief verwijderd in plaats van het naar de Prullenbak te verplaatsen. InstallerClean vroeg om de Prullenbak, en Windows deed dit in plaats daarvan. Het bestand is weg.`,
  ...
  'Cli.RecycleUnavailable': `Fout: de Prullenbak is niet beschikbaar voor dit volume, dus er is niets verwijderd. Gebruik /m om de bestanden te verplaatsen, of schakel de Prullenbak weer in en voer de opdracht opnieuw uit.`,
  ...
  'Cli.Help.ScanOnly': `  installerclean-cli /s         Alleen scannen - verwijderbare bestanden tonen`,
  'Cli.Help.Delete': `  installerclean-cli /d         Verwijderbare bestanden verwijderen (Prullenbak)`,
  'Cli.Help.MoveDefault': `  installerclean-cli /m         Verplaatsen naar de opgeslagen standaardlocatie`,
  ...
  'Cli.Help.MoveScheduledNote': `De opgeslagen standaard is per gebruiker; geplande of SYSTEM-runs hebben /m PAD nodig.`,
  'Cli.Help.ExitCodesHeader': `Afsluitcodes:`,
  'Cli.Help.ExitCodeOk': `  0   gelukt: elk aangemerkt bestand is verwerkt`,
  'Cli.Help.ExitCodeError': `  1   mislukt: niets verwerkt (foute argumenten, scan mislukt, alle bestanden mislukt)`,
  'Cli.Help.ExitCodePartial': `  2   gedeeltelijk: sommige bestanden verwerkt, sommige mislukt`,
  'Cli.Help.ExitCodeTransient': `  75  tijdelijk: een tijdelijke situatie blokkeerde de run (zie de melding)`,
