...
const MAP = {
  ...
  'Cli.NothingOffered.Singular': `InstallerClean kon niet met zekerheid vaststellen welke bestanden in de cache bij de hier geïnstalleerde programma's horen, en heeft daarom het ene bestand ({2}) achtergehouden dat het anders had aangeboden.`,
  'Cli.NothingOffered.Plural': `InstallerClean kon niet met zekerheid vaststellen welke bestanden in de cache bij de hier geïnstalleerde programma's horen, en heeft daarom alle {0} {1} ({2}) achtergehouden die het anders had aangeboden.`,
  ...
  'Summary.SupersededHeldBack.Singular': `Op deze pc kon InstallerClean niet met zekerheid vaststellen dat het ene vervangen bestand niet meer nodig is, en heeft het daarom achtergehouden.`,
  'Summary.SupersededHeldBack.Plural': `Op deze pc kon InstallerClean niet met zekerheid vaststellen dat {0} vervangen bestanden niet meer nodig zijn, en heeft ze daarom achtergehouden.`,
  'Cli.SupersededHeldBack.Singular': `Op deze pc kon InstallerClean niet met zekerheid vaststellen dat het ene vervangen bestand niet meer nodig is, en heeft het daarom achtergehouden.`,
  'Cli.SupersededHeldBack.Plural': `Op deze pc kon InstallerClean niet met zekerheid vaststellen dat {0} vervangen bestanden niet meer nodig zijn, en heeft ze daarom achtergehouden.`,
  'Completion.HeldBack.Singular': `{0} bestand achtergehouden. De scan noemde het overbodig. De laatste controle was het daar niet mee eens.`,
  'Completion.HeldBack.Plural': `{0} bestanden achtergehouden. De scan noemde ze overbodig. De laatste controle was het daar niet mee eens.`,
  ...
  'Cli.NothingListed.Singular': `Op deze pc kon InstallerClean niet met zekerheid vaststellen welke bestanden in de cache bij de hier geïnstalleerde programma's horen, dus is dat ene bestand ({2}) achtergehouden in plaats van vermeld.`,
  'Cli.NothingListed.Plural': `Op deze pc kon InstallerClean niet met zekerheid vaststellen welke bestanden in de cache bij de hier geïnstalleerde programma's horen, dus zijn {0} {1} ({2}) achtergehouden in plaats van vermeld.`,
  'Cli.WithheldReasons.Header': `Waarom die zekerheid er niet was:`,
  'Cli.WithheldReasons.RecordedPath': `  Een bestandspad uit de eigen administratie van Windows Installer was niet te herleiden.`,
  'Cli.WithheldReasons.FileIdentity': `  De identiteit van een bestand dat in de administratie van Windows Installer staat, was niet te lezen.`,
  'Cli.WithheldReasons.SecondInstance': `  Een programma is mogelijk meer dan één keer op deze pc geïnstalleerd.`,
