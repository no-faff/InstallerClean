...
const MAP = {
  ...
  'Summary.MissingFromDisk.Singular': `{0} geregistreerde bestand ontbreekt. Op dit moment levert dit geen problemen op, maar een toekomstige reparatie, update of verwijdering van dat programma zou kunnen mislukken. Open ‘Details’ voor meer informatie over wat je moet doen.`,
  ...
  'Error.ScanCorrelationFailed': `InstallerClean kon de Windows Installer-records niet vergelijken met de inhoud van {InstallerFolder}. Bijna niets waarnaar de records verwijzen, is daadwerkelijk aanwezig, en bijna niets wat er wel staat, wordt door een record genoemd, dus er kon niets als overbodig worden aangemerkt. Er is niets voorgesteld en er is niets verwijderd.`,
  ...
  'Error.DestinationInSystemFolder': `De bestemming {0} komt uit onder een Windows-systeemmap. Kies een pad buiten %SystemRoot%, %ProgramFiles%, %ProgramFiles(x86)% en %ProgramData%.`,
  ...
  'Cli.GenericError': `Fout: onverwachte storing ({0}). Details weggeschreven naar {1}.`,
  'Cli.GenericError.NoLog': `Fout: onverwachte storing ({0}). Het crashlog kon niet worden weggeschreven.`,
  ...
  'Cli.PendingRebootBlocked.MsiExecuteMutex': `Fout: Windows Installer wordt momenteel door iets anders gebruikt, bijvoorbeeld door Windows Update of een programma dat op de achtergrond wordt geïnstalleerd. De opties /m en /d worden geblokkeerd zolang dit proces loopt. Probeer het opnieuw zodra het proces is voltooid.`,
  ...
  'Cli.Help.ExitCodeOk': `  0   geslaagd: de uitvoering is klaar en er is niets meer te doen`,
  ...
  'Confirm.DeletePermanently.Plural': `Bestanden worden definitief verwijderd. Ze zijn [veilig te verwijderen], maar wil je een back-up, gebruik dan de knop Verplaatsen.`,
  ...
  'Cli.MissingFromDisk.Singular': `{0} geregistreerde bestand ontbreekt in {InstallerFolder}. Op dit moment levert dit geen problemen op, maar een toekomstige reparatie, update of verwijdering van dat programma zou kunnen mislukken. Door het installatieprogramma van dat programma opnieuw uit te voeren, bij voorkeur dezelfde versie, wordt het bestand teruggezet.`,
  ...
  'Cli.Help.Summary': `Verwijdert .msi- en .msp-bestanden die geen programma meer nodig heeft.`,
