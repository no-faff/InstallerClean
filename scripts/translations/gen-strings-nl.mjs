...
const MAP = {
  ...
  'Status.MoveFailed.NoLog': `{0}. Het crashlog kon niet worden weggeschreven.`,
  'Status.DeleteFailed': `{0}. Details in {1}.`,
  'Status.DeleteFailed.NoLog': `{0}. Het crashlog kon niet worden weggeschreven.`,
  ...
  'Completion.FailedCount.Singular': `{0} bestand kon niet worden verplaatst.`,
  'Completion.FailedCount.Plural': `{0} bestanden konden niet worden verplaatst.`,
  'Completion.FailedCountDelete.Singular': `{0} bestand kon niet worden verwijderd.`,
  ...
  'Error.StoppedTitle': `InstallerClean is gestopt`,
  ...
  'Error.MsiNonSuccess': `Windows Installer kon InstallerClean geen leesbare lijst van de geïnstalleerde programma's geven: het las {1} {2} en daarna kwam een vermelding onleesbaar terug (foutcode {0}). In plaats van met een half gelezen lijst te werken is InstallerClean gestopt. Er is niets verwijderd.`,
  ...
  'BrowserLaunch.ClipboardOk': `De link staat op je klembord, dus je kunt hem zelf plakken:&#10;&#10;{0}`,
  'BrowserLaunch.ClipboardFailed': `InstallerClean kon de link ook niet naar je klembord kopiëren, dus hier is hij:&#10;&#10;{0}`,
  ...
  'Error.ScanInstallerFolderElsewhere': `InstallerClean kan {InstallerFolder} op deze pc niet scannen. Windows meldt die map als {0}, en InstallerClean scant alleen een Installer-map die Windows op zijn eigen pad meldt. Er is niets voor opruimen aangeboden en er is niets verwijderd.`,
  ...
  'Cli.InstallerLockAccessRefused': `Fout: Windows weigerde InstallerClean toestemming om te controleren of Windows Installer bezig was, dus kon het niet uitsluiten dat een bestand halverwege alsnog nodig zou zijn. Er is niets verwijderd.`,
  'Cli.MoveCancelledRestoreHint': `Het is eenvoudig ongedaan te maken. Verplaats ze vanuit {0} terug naar {InstallerFolder} en alles is weer zoals het was.`,
  'Cli.MoveInstallerLockAccessRefused': `Fout: Windows weigerde InstallerClean toestemming om te controleren of Windows Installer bezig was, dus kon het niet uitsluiten dat een bestand halverwege alsnog nodig zou zijn. Er is niets verplaatst.`,
  'Cli.PendingRebootBlocked.RegistryCheckUnreadable': `Fout: InstallerClean kon een van de registerwaarden die het controleert voordat het {InstallerFolder} aanraakt niet lezen, en kan dus een lopende of voor de volgende herstart ingeplande Windows Installer-bewerking niet uitsluiten. /m en /d zijn geblokkeerd. Start Windows opnieuw op en probeer het opnieuw. Als het lezen dan nog steeds mislukt, is dit geen machine die InstallerClean kan opruimen.`,
  'Completion.MoveCancelledRestoreHint': `Het is eenvoudig ongedaan te maken. Verplaats ze terug naar {InstallerFolder} en alles is weer zoals het was.`,
  'Error.InstallerLockAccessRefused': `Windows weigerde InstallerClean toestemming om te controleren of Windows Installer bezig was, dus kon het niet uitsluiten dat een bestand halverwege alsnog nodig zou zijn, en er is niets verwijderd.`,
  'Error.MoveInstallerLockAccessRefused': `Windows weigerde InstallerClean toestemming om te controleren of Windows Installer bezig was, dus kon het niet uitsluiten dat een bestand halverwege alsnog nodig zou zijn, en er is niets verplaatst.`,
  'Error.MoveStoppedTitle': `Verplaatsen gestopt`,
  'Field.NoNamedProduct': `(geen programma)`,
