...
const MAP = {
  ...
  'Body.PendingReboot.MsiExecuteMutex': `Er is op dit moment iets bezig met Windows Installer, meestal een Windows-update of een programma dat op de achtergrond installeert. Verplaatsen en Verwijderen staan stil zolang dat loopt, zodat InstallerClean {InstallerFolder} niet aanraakt terwijl daar iets verandert. Zodra het klaar is, klik je op Opnieuw scannen en komen ze terug.`,
  ...
  'Cli.PendingRebootBlocked.MsiExecuteMutex': `Fout: er is op dit moment iets bezig met Windows Installer, meestal een Windows-update of een programma dat op de achtergrond installeert. /m en /d zijn geblokkeerd zolang dat loopt. Probeer het opnieuw zodra het klaar is.`,
