...
const MAP = {
  ...
  'Error.StoppedTitle': `InstallerClean이 멈췄습니다`,
  ...
  'Error.MsiNonSuccess': `Windows Installer가 InstallerClean에게 읽을 수 있는 설치된 프로그램 목록을 주지 못했습니다. {1} {2}을(를) 읽은 다음 항목 하나가 읽을 수 없는 상태로 돌아왔습니다(오류 코드 {0}). 일부만 읽은 목록으로 작업하는 대신 InstallerClean은 멈췄습니다. 아무것도 제거되지 않았습니다.`,
  ...
  'BrowserLaunch.ClipboardOk': `링크가 클립보드에 있으니 직접 붙여 넣으면 됩니다:&#10;&#10;{0}`,
  'BrowserLaunch.ClipboardFailed': `InstallerClean이 링크를 클립보드에 복사하지도 못했습니다. 링크는 다음과 같습니다:&#10;&#10;{0}`,
  ...
  'Completion.MoveCancelledSummary': `취소하기 전까지 {2} {1}개 중 {0}개를 {3}(으)로 이동했습니다.`,
  ...
  'Error.ScanInstallerFolderElsewhere': `InstallerClean은 이 PC에서 {InstallerFolder}를 검사할 수 없습니다. Windows는 이 폴더를 {0}(으)로 보고하며, InstallerClean은 Windows가 그 폴더 자체의 경로로 보고하는 Installer 폴더만 검사합니다. 아무것도 제시하지 않았고 아무것도 제거하지 않았습니다.`,
