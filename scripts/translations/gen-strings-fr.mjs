...
const MAP = {
  ...
  'Cli.Help.ScanOnly': `  installerclean-cli /s          Analyse seule - liste les fichiers inutiles`,
  'Cli.Help.Delete': `  installerclean-cli /d          Supprime les fichiers inutiles (Corbeille)`,
  'Cli.Help.MoveDefault': `  installerclean-cli /m          Déplace vers l'emplacement par défaut enregistré`,
  ...
  'Cli.Help.NoteLine3': `pour tout autre exécutable de console. L'interface se trouve dans InstallerClean.exe.`,
  'Cli.Help.ExitCodesHeader': `Codes de sortie :`,
  'Cli.Help.ExitCodeOk': `  0   succès : tous les fichiers signalés ont été traités`,
  'Cli.Help.ExitCodeError': `  1   échec : rien de traité (arguments incorrects, échec de l'analyse, tous les fichiers ont échoué)`,
  'Cli.Help.ExitCodePartial': `  2   partiel : certains fichiers traités, d'autres ont échoué`,
  'Cli.Help.ExitCodeTransient': `  75  transitoire : une condition temporaire a bloqué l'exécution (voir le message)`,
  ...
  'Cli.Help.MoveScheduledNote': `La valeur par défaut enregistrée est propre à chaque utilisateur ; les exécutions planifiées ou sous le compte SYSTEM nécessitent /m CHEMIN.`,
