...
const MAP = {
  ...
  'Cli.WithheldReasons.DeclaredProductUnestablished': `  Soit un fichier n'a pas indiqué à quel programme il appartient, soit Windows n'a pas répondu au sujet de ce programme.`,
