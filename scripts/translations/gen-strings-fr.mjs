...
const MAP = {
  ...
  'Summary.SupersededHeldBack.Singular': `Sur ce PC, InstallerClean n'a pas pu déterminer avec certitude que le seul fichier remplacé n'est plus nécessaire, il l'a donc retenu.`,
  'Summary.SupersededHeldBack.Plural': `Sur ce PC, InstallerClean n'a pas pu déterminer avec certitude que {0} fichiers remplacés ne sont plus nécessaires, il les a donc retenus.`,
  'Cli.SupersededHeldBack.Singular': `Sur ce PC, InstallerClean n'a pas pu déterminer avec certitude que le seul fichier remplacé n'est plus nécessaire, il l'a donc retenu.`,
  'Cli.SupersededHeldBack.Plural': `Sur ce PC, InstallerClean n'a pas pu déterminer avec certitude que {0} fichiers remplacés ne sont plus nécessaires, il les a donc retenus.`,
  'Completion.HeldBack.Singular': `{0} fichier retenu. L'analyse l'a jugé inutile. La vérification finale n'était pas d'accord.`,
  'Completion.HeldBack.Plural': `{0} fichiers retenus. L'analyse les a jugés inutiles. La vérification finale n'était pas d'accord.`,
  ...
  'Cli.NothingListed.Singular': `Sur ce PC, InstallerClean n'a pas pu déterminer avec certitude quels fichiers en cache appartiennent aux programmes installés ici, il a donc retenu l'unique fichier ({2}) au lieu de le lister.`,
  'Cli.NothingListed.Plural': `Sur ce PC, InstallerClean n'a pas pu déterminer avec certitude quels fichiers en cache appartiennent aux programmes installés ici, il a donc retenu {0} {1} ({2}) au lieu de les lister.`,
  'Cli.WithheldReasons.Header': `Pourquoi la certitude n'était pas possible :`,
  'Cli.WithheldReasons.RecordedPath': `  Un chemin de fichier issu des propres enregistrements de Windows Installer n'a pas pu être résolu.`,
  'Cli.WithheldReasons.FileIdentity': `  L'identité d'un fichier nommé dans les enregistrements de Windows Installer n'a pas pu être lue.`,
  'Cli.WithheldReasons.SecondInstance': `  Un programme est peut-être installé plusieurs fois sur ce PC.`,
