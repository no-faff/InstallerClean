...
const MAP = {
  ...
  'Body.PendingReboot.MsiExecuteMutexAccessRefused': `Windows a refusé à InstallerClean l'autorisation de vérifier si Windows Installer est occupé, donc Déplacer et Supprimer sont en pause et InstallerClean ne touchera pas à {InstallerFolder}. Redémarrez Windows puis Réanalyser. Si Windows refuse toujours, ce n'est pas une machine qu'InstallerClean peut nettoyer.`,
  ...
  'Status.MoveFailed': `{0}. Détails dans {1}.`,
  'Status.MoveFailed.NoLog': `{0}. Le crash.log n'a pas pu être écrit.`,
  'Status.DeleteFailed': `{0}. Détails dans {1}.`,
  'Status.DeleteFailed.NoLog': `{0}. Le crash.log n'a pas pu être écrit.`,
  ...
  'Completion.FailedCount.Singular': `{0} fichier n'a pas pu être déplacé.`,
  'Completion.FailedCount.Plural': `{0} fichiers n'ont pas pu être déplacés.`,
  'Completion.FailedCountDelete.Singular': `{0} fichier n'a pas pu être supprimé.`,
  'Completion.FailedCountDelete.Plural': `{0} fichiers n'ont pas pu être supprimés.`,
  ...
  'Summary.NothingListed.Singular': `InstallerClean n'a pas pu déterminer avec certitude quels fichiers en cache appartiennent aux programmes installés ici, il a donc retenu le seul fichier au lieu de le proposer.`,
  'Summary.NothingListed.Plural': `InstallerClean n'a pas pu déterminer avec certitude quels fichiers en cache appartiennent aux programmes installés ici, il a donc retenu {0} {1} au lieu de les proposer.`,
  'Summary.MissingFromDisk.Singular': `Windows a un enregistrement pour {0} fichier qui n'est pas dans {InstallerFolder} : {1}. Cela ne pose aucun problème au quotidien, mais une mise à jour ou une désinstallation de ce programme peut échouer. Ouvrez Détails pour savoir quoi faire.`,
  'Summary.MissingFromDisk.Plural': `Windows a des enregistrements pour {0} fichiers qui ne sont pas dans {InstallerFolder} : {1}. Cela ne pose aucun problème au quotidien, mais une mise à jour ou une désinstallation de ces programmes peut échouer. Ouvrez Détails pour savoir quoi faire.`,
  ...
  'Error.StoppedTitle': `InstallerClean s'est arrêté`,
  ...
  'Error.MsiNonSuccess': `Windows Installer n'a pas pu fournir à InstallerClean une liste lisible des programmes installés : il a lu {1} {2}, puis une entrée est revenue illisible (code d'erreur {0}). Plutôt que de travailler sur une liste lue en partie, InstallerClean s'est arrêté. Rien n'a été supprimé.`,
  ...
  'Startup.AlreadyRunningTitle': `InstallerClean`,
  'Startup.AlreadyRunningBody': `Il est déjà en cours d'exécution.`,
  'Startup.UnhandledTitle': `InstallerClean`,
  ...
  'Tooltip.MoveSameDrive': `Déplace les fichiers inutiles vers le dossier de sauvegarde. Il est sur le même disque, vous ne récupérerez donc l'espace qu'après avoir supprimé ce dossier.`,
  'Confirm.DeletePermanently.Singular': `Ce fichier sera supprimé définitivement. C'est sans risque, mais si vous voulez une sauvegarde, utilisez plutôt Déplacer.`,
  'Confirm.DeletePermanently.Plural': `Ces fichiers seront supprimés définitivement. C'est sans risque, mais si vous voulez une sauvegarde, utilisez plutôt Déplacer.`,
  ...
  'Error.ScanInstallerFolderElsewhere': `InstallerClean ne peut pas analyser {InstallerFolder} sur ce PC. Windows indique que ce dossier se trouve à {0}, et InstallerClean n'analyse un dossier Installer que si Windows l'indique à son propre chemin. Rien n'a été proposé et rien n'a été retiré.`,
  'Completion.NothingOffered': `Rien n'a été proposé sur ce PC`,
  'Completion.NothingOfferedBody.Singular': `InstallerClean n'a pas pu déterminer avec certitude quels fichiers en cache appartiennent aux programmes installés ici, il a donc retenu le seul fichier ({2}) au lieu de le proposer.`,
  'Completion.NothingOfferedBody.Plural': `InstallerClean n'a pas pu déterminer avec certitude quels fichiers en cache appartiennent aux programmes installés ici, il a donc retenu l'ensemble des {0} {1} ({2}) au lieu de les proposer.`,
  'Summary.SupersededHeldBack.Singular': `InstallerClean n'a pas pu déterminer avec certitude que le seul fichier remplacé n'est plus nécessaire, il l'a donc retenu.`,
  'Summary.SupersededHeldBack.Plural': `InstallerClean n'a pas pu déterminer avec certitude que {0} fichiers remplacés ne sont plus nécessaires, il les a donc retenus.`,
  'Cli.SupersededHeldBack.Singular': `InstallerClean n'a pas pu déterminer avec certitude que le seul fichier remplacé n'est plus nécessaire, il l'a donc retenu.`,
  'Cli.SupersededHeldBack.Plural': `InstallerClean n'a pas pu déterminer avec certitude que {0} fichiers remplacés ne sont plus nécessaires, il les a donc retenus.`,
  'Completion.HeldBack.Singular': `{0} fichier retenu. L'analyse l'a jugé inutile. La vérification finale n'a pas pu le confirmer.`,
  'Completion.HeldBack.Plural': `{0} fichiers retenus. L'analyse les a jugés inutiles. La vérification finale n'a pas pu le confirmer.`,
  'Body.PendingReboot.PendingRenameUnresolved': `Une opération sur fichiers est en file d'attente pour le prochain redémarrage et InstallerClean ne peut pas savoir quels fichiers elle nomme, il ne peut donc pas exclure qu'ils soient dans {InstallerFolder}. Redémarrez Windows avant de nettoyer.`,
  'Completion.MoveRestoreHint': `Supprimez ce dossier dès que vous serez convaincu que tout va bien.`,
  'Completion.MoveRestoreHintSameDrive': `Supprimez ce dossier dès que vous serez convaincu que tout va bien. Vous ne récupérerez l'espace qu'à ce moment-là.`,
  'Confirm.MoveDestination.Singular': `Ce fichier sera déplacé vers :`,
  'Confirm.MoveDestination.Plural': `Ces fichiers seront déplacés vers :`,
  'Cli.NothingListed.Singular': `InstallerClean n'a pas pu déterminer avec certitude quels fichiers en cache appartiennent aux programmes installés ici, il a donc retenu le seul fichier ({2}) au lieu de le proposer.`,
  'Cli.NothingListed.Plural': `InstallerClean n'a pas pu déterminer avec certitude quels fichiers en cache appartiennent aux programmes installés ici, il a donc retenu {0} {1} ({2}) au lieu de les proposer.`,
  'Cli.WithheldReasons.Header': `Pourquoi la certitude n'était pas possible :`,
  'Cli.WithheldReasons.RecordedPath': `  Un chemin de fichier issu des propres enregistrements de Windows Installer n'a pas pu être résolu, rien n'a donc pu lui être rapproché.`,
  'Cli.WithheldReasons.FileIdentity': `  Un fichier dont Windows garde un enregistrement n'a pas pu être identifié, il n'a donc pas pu être rapproché du contenu du dossier.`,
  'Cli.WithheldReasons.SecondInstance': `  Un programme est peut-être installé plusieurs fois sur ce PC, et les enregistrements ne peuvent pas dire à quelle copie appartient un fichier.`,
  'Cli.PendingRebootBlocked.PendingRenameUnresolved': `Erreur : une opération sur fichiers est en file d'attente pour le prochain redémarrage et InstallerClean ne peut pas savoir quels fichiers elle nomme, il ne peut donc pas exclure {InstallerFolder}. Redémarrez Windows avant de nettoyer.`,
  'Cli.MoveRestoreHint': `Vérifiez que vos programmes se mettent toujours à jour et se désinstallent normalement, puis supprimez {0}.`,
  'Error.ScanStoppedDetails': `Cela est également consigné dans {0}.`,
  'Cli.NothingListedPerFile.Singular': `InstallerClean n'a pas eu de certitude au sujet de l'un des fichiers en cache qu'il a trouvés, il a donc retenu celui-ci ({2}) au lieu de le proposer.`,
  'Cli.NothingListedPerFile.Plural': `InstallerClean n'a pas eu de certitude au sujet de certains des fichiers en cache qu'il a trouvés, il a donc retenu {0} {1} ({2}) au lieu de les proposer.`,
  'Cli.NothingOfferedPerFile.Singular': `InstallerClean n'a pas pu établir que le fichier en cache qu'il a trouvé est inutile, il a donc retenu ce seul fichier ({2}) au lieu de le proposer.`,
  'Cli.NothingOfferedPerFile.Plural': `InstallerClean n'a pu établir d'aucun des fichiers en cache qu'il a trouvés qu'il est inutile, il a donc retenu l'ensemble des {0} {1} ({2}) au lieu de les proposer.`,
  'Completion.NothingOfferedPerFileBody.Singular': `InstallerClean n'a pas pu établir que le fichier en cache qu'il a trouvé est inutile, il a donc retenu ce seul fichier ({2}) au lieu de le proposer.`,
  'Completion.NothingOfferedPerFileBody.Plural': `InstallerClean n'a pu établir d'aucun des fichiers en cache qu'il a trouvés qu'il est inutile, il a donc retenu l'ensemble des {0} {1} ({2}) au lieu de les proposer.`,
  'Summary.NothingListedPerFile.Singular': `InstallerClean n'a pas eu de certitude au sujet de l'un des fichiers en cache qu'il a trouvés, il l'a donc retenu au lieu de le proposer.`,
  'Summary.NothingListedPerFile.Plural': `InstallerClean n'a pas eu de certitude au sujet de certains des fichiers en cache qu'il a trouvés, il a donc retenu {0} {1} au lieu de les proposer.`,
  'Cli.WithheldReasons.CandidateIdentity': `  Un fichier du dossier n'a pas pu être identifié, il n'a donc pas pu être rapproché des enregistrements.`,
  'Cli.WithheldReasons.DeclaredProductUnestablished': `  Soit un fichier n'a pas indiqué à quel programme il appartient, soit Windows n'a pas donné de réponse claire au sujet de ce programme.`,
  'Cli.WithheldReasons.ScreenUnanswered': `  Une vérification des programmes auxquels appartiennent les fichiers a donné des réponses qui ne correspondaient pas aux fichiers qui lui avaient été transmis.`,
  'Cli.WithheldReasons.DeclaredPatchUnestablished': `  Soit un fichier de correctif n'a pas indiqué de quel correctif il s'agit, soit il n'a pas indiqué à quels programmes il est destiné, soit Windows n'a pas indiqué de façon complète quels programmes ont ce correctif.`,
  'Body.PendingReboot.RegistryCheckUnreadable': `InstallerClean n'a pas pu lire l'un des paramètres Windows qu'il vérifie avant de toucher à {InstallerFolder}, il ne peut donc pas savoir si une opération d'installation est en cours ou attend un redémarrage. Redémarrez Windows puis Réanalyser. Si le paramètre reste illisible, ce n'est pas une machine qu'InstallerClean peut nettoyer.`,
  'Cli.InstallerLockAccessRefused': `Erreur : Windows a refusé à InstallerClean l'autorisation de vérifier si Windows Installer était occupé, il n'a donc pas pu exclure qu'un fichier devienne nécessaire en cours de route. Rien n'a été supprimé.`,
  'Cli.MoveCancelledRestoreHint': `C'est simple à annuler. Redéplacez-les depuis {0} dans {InstallerFolder} et tout redeviendra comme avant.`,
  'Cli.MoveInstallerLockAccessRefused': `Erreur : Windows a refusé à InstallerClean l'autorisation de vérifier si Windows Installer était occupé, il n'a donc pas pu exclure qu'un fichier devienne nécessaire en cours de route. Rien n'a été déplacé.`,
  'Cli.PendingRebootBlocked.RegistryCheckUnreadable': `Erreur : InstallerClean n'a pas pu lire l'une des valeurs de registre qu'il vérifie avant de toucher à {InstallerFolder}, il ne peut donc pas exclure une opération Windows Installer en cours ou mise en file d'attente pour le prochain redémarrage. /m et /d sont bloqués. Redémarrez Windows et réessayez. Si la lecture échoue toujours, ce n'est pas une machine qu'InstallerClean peut nettoyer.`,
  'Completion.MoveCancelledRestoreHint': `C'est simple à annuler. Redéplacez-les dans {InstallerFolder} et tout redeviendra comme avant.`,
  'Error.InstallerLockAccessRefused': `Windows a refusé à InstallerClean l'autorisation de vérifier si Windows Installer était occupé, il n'a donc pas pu exclure qu'un fichier devienne nécessaire en cours de route, et rien n'a été supprimé.`,
  'Error.MoveInstallerLockAccessRefused': `Windows a refusé à InstallerClean l'autorisation de vérifier si Windows Installer était occupé, il n'a donc pas pu exclure qu'un fichier devienne nécessaire en cours de route, et rien n'a été déplacé.`,
  'Error.MoveStoppedTitle': `Déplacement arrêté`,
  'Field.NoNamedProduct': `(aucun programme)`,
