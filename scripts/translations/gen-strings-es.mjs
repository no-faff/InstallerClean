...
const MAP = {
  ...
  'Section.Move.Location': `UBICACIÓN DE DESTINO`,
  ...
  'Action.Move': `_Mover`,
  'Action.MoveInstead': `_Mover en su lugar`,
  'Action.MoveDestinationPlaceholder': `Ruta de la carpeta si eliges Mover en lugar de Eliminar`,
  ...
  'Automation.RecycleUnavailable': `Elige qué hacer con los archivos innecesarios: moverlos a un lugar seguro, eliminarlos definitivamente o cancelar.`,
  'Automation.RecycleUnavailableMove': `Mover los archivos innecesarios a una carpeta que tú elijas`,
  'Automation.RecycleUnavailableDeletePermanently': `Eliminar definitivamente los archivos innecesarios porque la Papelera de reciclaje no está disponible para esta unidad`,
  ...
  'Automation.Section.MoveLocation': `Ubicación de destino`,
  ...
  'Automation.MoveDestinationFolder': `Ubicación de destino`,
  ...
  'Completion.MoveRestoreHint': `Vuelve a copiarlos a {InstallerFolder} si alguna vez falla algo ([extremadamente improbable]).`,
  'Completion.DeleteRestoreHint': `Hasta entonces, puedes restaurarlos si alguna vez falla algo ([extremadamente improbable]).`,
  ...
  'Completion.DeleteSummary.Singular': `{0} {1} en la Papelera de reciclaje`,
  'Completion.DeleteSummary.Plural': `{0} {1} en la Papelera de reciclaje`,
  ...
  'Completion.PermanentDeleteRestoreHint.Singular': `No pasa nada, se podía eliminar sin riesgo. InstallerClean solo elimina los archivos que Windows da por terminados, nunca uno que un programa todavía necesita. En el caso improbable de que una eliminación llegara a dejar un programa sin poder repararse, actualizarse o desinstalarse, reinstalarlo desde su fabricante suele restaurar el archivo, aunque Microsoft no lo garantiza.`,
  'Completion.PermanentDeleteRestoreHint.Plural': `No pasa nada, se podían eliminar sin riesgo. InstallerClean solo elimina los archivos que Windows da por terminados, nunca uno que un programa todavía necesita. En el caso improbable de que una eliminación llegara a dejar un programa sin poder repararse, actualizarse o desinstalarse, reinstalarlo desde su fabricante suele restaurar el archivo, aunque Microsoft no lo garantiza.`,
  'RecycleUnavailable.Heading': `La Papelera de reciclaje no está disponible para esta unidad`,
  'RecycleUnavailable.Body.Singular': `Así que este {1} ({2}) no se ha eliminado. Puedes moverlo a un lugar seguro, o eliminarlo definitivamente.`,
  'RecycleUnavailable.Body.Plural': `Así que estos {0} {1} ({2}) no se han eliminado. Puedes moverlos a un lugar seguro, o eliminarlos definitivamente.`,
  'RecycleUnavailable.Reassurance.Singular': `Eliminarlo es seguro. InstallerClean solo elimina los archivos que Windows da por terminados, nunca uno que un programa todavía necesita, y la Papelera de reciclaje es solo una protección adicional. En el caso improbable de que una eliminación llegara a dejar un programa sin poder repararse, actualizarse o desinstalarse, reinstalarlo desde su fabricante suele restaurar el archivo, aunque Microsoft no lo garantiza.`,
  'RecycleUnavailable.Reassurance.Plural': `Eliminarlos es seguro. InstallerClean solo elimina los archivos que Windows da por terminados, nunca uno que un programa todavía necesita, y la Papelera de reciclaje es solo una protección adicional. En el caso improbable de que una eliminación llegara a dejar un programa sin poder repararse, actualizarse o desinstalarse, reinstalarlo desde su fabricante suele restaurar el archivo, aunque Microsoft no lo garantiza.`,
  ...
  'Confirm.DeleteToRecycleBin': `Los archivos se moverán a la Papelera de reciclaje. Si quieres copias de seguridad, usa el botón Mover en su lugar.`,
  ...
  'Error.ShellRecycleFailed': `No se pudo mover este archivo a la Papelera de reciclaje (error {0}), y con ese código InstallerClean no puede decirte por qué. El archivo se dejó donde estaba. Prueba el botón Mover, que no usa la Papelera de reciclaje.`,
  'Error.RecycleAccessDenied': `Windows denegó el acceso incluso con permisos de administrador (error {0}), e InstallerClean no puede saber si el problema es el archivo o la Papelera de reciclaje. El archivo se dejó donde estaba. El botón Mover funcionará si el problema es la Papelera de reciclaje, pero no si es el archivo.`,
  'Error.RecycleInUse': `Este archivo está abierto o bloqueado por otro programa (error {0}), así que ahora mismo nada puede quitarlo. Se dejó donde estaba; inténtalo más tarde.`,
  'Error.DeletedNotRecycled': `Windows eliminó este archivo directamente en lugar de moverlo a la Papelera de reciclaje. InstallerClean pidió la Papelera de reciclaje y Windows hizo otra cosa. El archivo ya no está.`,
  ...
  'Cli.RecycleUnavailable': `Error: la Papelera de reciclaje no está disponible para este volumen, así que no se eliminó nada. Usa /m para mover los archivos en su lugar, o vuelve a activar la Papelera de reciclaje y ejecuta de nuevo.`,
  ...
  'Cli.Help.ScanOnly': `  installerclean-cli /s         Solo análisis - enumera los archivos innecesarios`,
  'Cli.Help.Delete': `  installerclean-cli /d         Elimina los archivos innecesarios (Papelera de reciclaje)`,
  'Cli.Help.MoveDefault': `  installerclean-cli /m         Mueve a la ubicación predeterminada guardada`,
  ...
  'Cli.Help.NoteLine3': `con cualquier otro ejecutable de consola. La GUI está en InstallerClean.exe.`,
  'Cli.Help.ExitCodesHeader': `Códigos de salida:`,
  'Cli.Help.ExitCodeOk': `  0   correcto: se procesó cada archivo señalado`,
  'Cli.Help.ExitCodeError': `  1   error: no se procesó nada (argumentos incorrectos, análisis fallido, todos los archivos fallaron)`,
  'Cli.Help.ExitCodePartial': `  2   parcial: algunos archivos procesados, otros fallaron`,
  'Cli.Help.ExitCodeTransient': `  75  transitorio: una condición temporal bloqueó la ejecución (consulta el mensaje)`,
  ...
  'Completion.CleanedUp': `{0} limpiados`,
  'Completion.DeleteSpaceHint': `Vacíala para liberar el espacio de verdad.`,
  ...
  'Completion.DeleteCancelledSummary': `Cancelaste tras mover {0} de {1} {2} a la Papelera de reciclaje.`,
  ...
  'Cli.Help.MoveScheduledNote': `La ubicación predeterminada guardada es por usuario; las ejecuciones programadas o con la cuenta SYSTEM necesitan /m RUTA.`,
  ...
  'Status.CheckingRecycleBin': `Comprobando la Papelera de reciclaje...`,
