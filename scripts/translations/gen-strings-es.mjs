...
const MAP = {
  ...
  'Automation.BuyMeACuppa.About': `Donar`,
  'Automation.Donate': `Donar`,
  ...
  'Tooltip.BuyMeACuppa.About': `Cualquier donación, por pequeña que sea, se agradece mucho.`,
  ...
  'Body.PendingReboot.MsiExecuteMutexAccessRefused': `Windows le negó a InstallerClean el permiso para comprobar si Windows Installer está ocupado, así que Mover y Eliminar están en pausa e InstallerClean no tocará {InstallerFolder}. Reinicia Windows y usa Volver a analizar. Si Windows sigue negándolo, este no es un equipo que InstallerClean pueda limpiar.`,
  ...
  'Status.MoveFailed': `{0}. Detalles en {1}.`,
  'Status.MoveFailed.NoLog': `{0}. No se pudo escribir el archivo crash.log.`,
  'Status.DeleteFailed': `{0}. Detalles en {1}.`,
  'Status.DeleteFailed.NoLog': `{0}. No se pudo escribir el archivo crash.log.`,
  ...
  'Completion.FailedCount.Singular': `No se pudo mover {0} archivo.`,
  'Completion.FailedCount.Plural': `No se pudieron mover {0} archivos.`,
  'Completion.FailedCountDelete.Singular': `No se pudo eliminar {0} archivo.`,
  'Completion.FailedCountDelete.Plural': `No se pudieron eliminar {0} archivos.`,
  ...
  'Summary.NothingListed.Singular': `InstallerClean no pudo determinar con certeza qué archivos en caché pertenecen a los programas instalados aquí, así que ha retenido el único archivo en lugar de ofrecerlo.`,
  'Summary.NothingListed.Plural': `InstallerClean no pudo determinar con certeza qué archivos en caché pertenecen a los programas instalados aquí, así que ha retenido {0} {1} en lugar de ofrecerlos.`,
  ...
  'Error.StoppedTitle': `InstallerClean se detuvo`,
  ...
  'Error.MsiNonSuccess': `Windows Installer no pudo darle a InstallerClean una lista legible de los programas instalados: leyó {1} {2} y luego una entrada llegó ilegible (código de error {0}). En lugar de trabajar con una lista leída a medias, InstallerClean se detuvo. No se ha eliminado nada.`,
  'Error.InvalidDestinationTitle': `Destino no válido`,
  'Error.DestinationWriteFailedTitle': `No se pudo usar esa carpeta de copia de seguridad`,
  ...
  'BrowserLaunch.ClipboardOk': `El enlace está en el portapapeles, así que puedes pegarlo tú mismo:&#10;&#10;{0}`,
  'BrowserLaunch.ClipboardFailed': `InstallerClean tampoco pudo copiar el enlace al portapapeles, así que aquí está:&#10;&#10;{0}`,
  ...
  'Completion.DonateAsk': `Cualquier donación, por pequeña que sea, se agradece mucho.`,
  ...
  'Cli.NothingOffered.Singular': `InstallerClean no pudo determinar con certeza qué archivos en caché pertenecen a los programas instalados aquí, así que ha retenido el único archivo ({2}) en lugar de ofrecerlo.`,
  ...
  'Error.ScanInstallerFolderElsewhere': `InstallerClean no puede analizar {InstallerFolder} en este PC. Windows sitúa esa carpeta en {0}, e InstallerClean solo analiza una carpeta Installer que Windows sitúe en su propia ruta. No se ha ofrecido nada y no se ha quitado nada.`,
  'Completion.NothingOffered': `No se ofreció nada en este PC`,
  'Completion.NothingOfferedBody.Singular': `InstallerClean no pudo determinar con certeza qué archivos en caché pertenecen a los programas instalados aquí, así que ha retenido el único archivo ({2}) en lugar de ofrecerlo.`,
  'Completion.NothingOfferedBody.Plural': `InstallerClean no pudo determinar con certeza qué archivos en caché pertenecen a los programas instalados aquí, así que ha retenido todos los {0} {1} ({2}) en lugar de ofrecerlos.`,
  'Summary.SupersededHeldBack.Singular': `InstallerClean no pudo determinar con certeza que el único archivo sustituido ya no haga falta, así que lo ha retenido.`,
  'Summary.SupersededHeldBack.Plural': `InstallerClean no pudo determinar con certeza que {0} archivos sustituidos ya no hagan falta, así que los ha retenido.`,
  'Cli.SupersededHeldBack.Singular': `InstallerClean no pudo determinar con certeza que el único archivo sustituido ya no haga falta, así que lo ha retenido.`,
  'Cli.SupersededHeldBack.Plural': `InstallerClean no pudo determinar con certeza que {0} archivos sustituidos ya no hagan falta, así que los ha retenido.`,
  'Completion.HeldBack.Singular': `{0} archivo retenido. El análisis dijo que no era necesario. La comprobación final no pudo confirmarlo.`,
  'Completion.HeldBack.Plural': `{0} archivos retenidos. El análisis dijo que no eran necesarios. La comprobación final no pudo confirmarlo.`,
  ...
  'Cli.NothingListed.Singular': `InstallerClean no pudo determinar con certeza qué archivos en caché pertenecen a los programas instalados aquí, así que ha retenido el único archivo ({2}) en lugar de ofrecerlo.`,
  'Cli.NothingListed.Plural': `InstallerClean no pudo determinar con certeza qué archivos en caché pertenecen a los programas instalados aquí, así que ha retenido {0} {1} ({2}) en lugar de ofrecerlos.`,
  'Cli.WithheldReasons.Header': `Por qué no pudo tener la certeza:`,
  'Cli.WithheldReasons.RecordedPath': `  Una ruta de archivo de los propios registros de Windows Installer no se pudo resolver, así que no se le pudo cotejar nada.`,
  'Cli.WithheldReasons.FileIdentity': `  No se pudo identificar un archivo del que Windows tiene registro, así que no se pudo cotejar con lo que hay en la carpeta.`,
  'Cli.WithheldReasons.SecondInstance': `  Puede que un programa esté instalado más de una vez en este PC, y los registros no pueden decir a qué copia pertenece un archivo.`,
  ...
  'Cli.NothingListedPerFile.Singular': `InstallerClean no tuvo la certeza sobre uno de los archivos en caché que encontró, así que ha retenido ese ({2}) en lugar de ofrecerlo.`,
  'Cli.NothingListedPerFile.Plural': `InstallerClean no tuvo la certeza sobre algunos de los archivos en caché que encontró, así que ha retenido {0} {1} ({2}) en lugar de ofrecerlos.`,
  'Cli.NothingOfferedPerFile.Singular': `InstallerClean no pudo establecer que el archivo en caché que encontró ya no fuera necesario, así que ha retenido ese único archivo ({2}) en lugar de ofrecerlo.`,
  'Cli.NothingOfferedPerFile.Plural': `InstallerClean no pudo establecer de ninguno de los archivos en caché que encontró que ya no fuera necesario, así que ha retenido todos los {0} {1} ({2}) en lugar de ofrecerlos.`,
  'Completion.NothingOfferedPerFileBody.Singular': `InstallerClean no pudo establecer que el archivo en caché que encontró ya no fuera necesario, así que ha retenido ese único archivo ({2}) en lugar de ofrecerlo.`,
  'Completion.NothingOfferedPerFileBody.Plural': `InstallerClean no pudo establecer de ninguno de los archivos en caché que encontró que ya no fuera necesario, así que ha retenido todos los {0} {1} ({2}) en lugar de ofrecerlos.`,
  ...
  'Cli.InstallerLockAccessRefused': `Error: Windows le negó a InstallerClean el permiso para comprobar si Windows Installer estaba ocupado, así que no pudo descartar que un archivo hiciera falta a mitad del proceso. No se ha eliminado nada.`,
  'Cli.MoveCancelledRestoreHint': `Deshacerlo es sencillo. Muévelos de vuelta desde {0} a {InstallerFolder} y todo quedará como estaba.`,
  'Cli.MoveInstallerLockAccessRefused': `Error: Windows le negó a InstallerClean el permiso para comprobar si Windows Installer estaba ocupado, así que no pudo descartar que un archivo hiciera falta a mitad del proceso. No se ha movido nada.`,
  'Cli.PendingRebootBlocked.RegistryCheckUnreadable': `Error: InstallerClean no pudo leer uno de los valores del registro que comprueba antes de tocar {InstallerFolder}, así que no puede descartar una operación de Windows Installer en curso o en cola para el próximo reinicio. /m y /d están bloqueados. Reinicia Windows y vuelve a intentarlo. Si la lectura sigue fallando, este no es un equipo que InstallerClean pueda limpiar.`,
  'Completion.MoveCancelledRestoreHint': `Deshacerlo es sencillo. Muévelos de vuelta a {InstallerFolder} y todo quedará como estaba.`,
  'Error.InstallerLockAccessRefused': `Windows le negó a InstallerClean el permiso para comprobar si Windows Installer estaba ocupado, así que no pudo descartar que un archivo hiciera falta a mitad del proceso, y no se ha eliminado nada.`,
  'Error.MoveInstallerLockAccessRefused': `Windows le negó a InstallerClean el permiso para comprobar si Windows Installer estaba ocupado, así que no pudo descartar que un archivo hiciera falta a mitad del proceso, y no se ha movido nada.`,
  'Error.MoveStoppedTitle': `Movimiento detenido`,
  'Field.NoNamedProduct': `(sin programa)`,
