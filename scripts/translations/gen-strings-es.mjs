...
const MAP = {
  ...
  'Section.Backup.Folder': `CARPETA DE DESTINO`,
  ...
  'Automation.Section.BackupFolder': `Carpeta de destino`,
  'Automation.Section.Patches': `Parches`,
  'Automation.Section.ProductDetails': `Detalles del producto`,
  'Automation.BackupFolder': `Carpeta de destino`,
  ...
  'Tooltip.Move': `Mueve los archivos innecesarios a la carpeta de destino. Elimina esa carpeta cuando estés convencido de que nada los necesita.`,
  'Tooltip.MoveNeedsDestination': `Mueve los archivos innecesarios a una carpeta de destino. La elegirás a continuación. Elimina esa carpeta cuando estés convencido de que nada los necesita.`,
  'Tooltip.Delete': `Elimina definitivamente los archivos innecesarios. Se pueden quitar sin riesgo, y recuperarás el espacio de inmediato.`,
  ...
  'Body.MainExplanation.Action': `Muévelos a una carpeta de destino que elijas y elimina esa carpeta cuando compruebes que tus programas se siguen actualizando, reparando y desinstalando con normalidad. Devolverlos a {InstallerFolder} lo restaura todo. O elimínalos definitivamente ahora.`,
  ...
  'Confirm.MoveDestination': `Mover a:`,
  ...
  'Error.DestinationNotFullyQualified': `La carpeta de destino tiene que ser una ruta completa a una carpeta, empezando por una letra de unidad o un recurso compartido de red (por ejemplo D:\\Backup, o \\\\servidor\\backup). InstallerClean no puede usar esta: {0}`,
  ...
  'Error.DestinationChangedMidBatch': `InstallerClean ya no pudo confirmar la carpeta de destino, así que se detuvo en lugar de escribir en el sitio equivocado. Comprueba {0}, luego Volver a analizar e inténtalo de nuevo.`,
  ...
  'Cli.Help.MoveDefault': `  installerclean-cli /m         Mueve a la carpeta de destino guardada`,
  ...
  'Cli.Help.MoveScheduledNote': `Se guarda por usuario; las ejecuciones programadas o SYSTEM usan /m RUTA.`,
  ...
  'Tooltip.MoveSameDrive': `Mueve los archivos innecesarios a la carpeta de destino. Está en la misma unidad, así que no recuperarás el espacio hasta que elimines esa carpeta o la muevas a otra unidad. Puedes hacerlo cuando estés convencido de que nada los necesita.`,
  'Completion.MoveRestoreHint.Singular': `El archivo de esa carpeta se puede [quitar sin riesgo], así que elimina la carpeta cuando quieras. Hasta entonces, puedes devolverlo a {InstallerFolder} si algún programa resulta necesitarlo (extremadamente improbable).`,
  'Completion.MoveRestoreHint.Plural': `Los archivos de esa carpeta se pueden [quitar sin riesgo], así que elimínala cuando quieras. Hasta entonces, puedes devolverlos a {InstallerFolder} si algún programa resulta necesitar alguno (extremadamente improbable).`,
  'Completion.MoveRestoreHintSameDrive.Singular': `El archivo de esa carpeta se puede [quitar sin riesgo], así que elimina la carpeta o muévela a otra unidad cuando quieras recuperar el espacio de verdad. Hasta entonces, puedes devolverlo a {InstallerFolder} si algún programa resulta necesitarlo (extremadamente improbable).`,
  'Completion.MoveRestoreHintSameDrive.Plural': `Los archivos de esa carpeta se pueden [quitar sin riesgo], así que elimínala o muévela a otra unidad cuando quieras recuperar el espacio de verdad. Hasta entonces, puedes devolverlos a {InstallerFolder} si algún programa resulta necesitar alguno (extremadamente improbable).`,
  'Confirm.DeletePermanently.Singular': `Este archivo se eliminará definitivamente. Se puede [eliminar sin riesgo], pero si quieres una copia, usa el botón Mover en su lugar.`,
  'Confirm.DeletePermanently.Plural': `Los archivos se eliminarán definitivamente. Se pueden [eliminar sin riesgo], pero si quieres una copia, usa el botón Mover en su lugar.`,
  ...
  'Completion.NothingOfferedBody.Singular': `InstallerClean no pudo determinar con certeza qué archivos almacenados en caché pertenecen a los programas instalados aquí, así que ha retenido el único archivo ({1}) que podría haber ofrecido.`,
  'Completion.NothingOfferedBody.Plural': `InstallerClean no pudo determinar con certeza qué archivos almacenados en caché pertenecen a los programas instalados aquí, así que ha retenido los {0} archivos ({1}) que podría haber ofrecido.`,
};
