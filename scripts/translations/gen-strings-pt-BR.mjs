...
const MAP = {
  ...
  'Cli.Help.ScanOnly': `  installerclean-cli /s          Apenas análise - arquivos desnecessários`,
  'Cli.Help.Delete': `  installerclean-cli /d          Exclui arquivos desnecessários (Lixeira)`,
