...
const MAP = {
  ...
  'Summary.SupersededHeldBack.Singular': `Neste PC o InstallerClean não conseguiu ter certeza de que o único arquivo substituído não é mais necessário, então o reteve.`,
  'Summary.SupersededHeldBack.Plural': `Neste PC o InstallerClean não conseguiu ter certeza de que {0} arquivos substituídos não são mais necessários, então os reteve.`,
  'Cli.SupersededHeldBack.Singular': `Neste PC o InstallerClean não conseguiu ter certeza de que o único arquivo substituído não é mais necessário, então o reteve.`,
  'Cli.SupersededHeldBack.Plural': `Neste PC o InstallerClean não conseguiu ter certeza de que {0} arquivos substituídos não são mais necessários, então os reteve.`,
  'Completion.HeldBack.Singular': `{0} arquivo retido. A análise disse que ele não era necessário. A verificação final não concordou.`,
  'Completion.HeldBack.Plural': `{0} arquivos retidos. A análise disse que eles não eram necessários. A verificação final não concordou.`,
  ...
  'Cli.NothingListed.Singular': `Neste PC o InstallerClean não teve certeza de quais arquivos em cache pertencem aos programas instalados aqui, então reteve o único arquivo ({2}) em vez de listá-lo.`,
  'Cli.NothingListed.Plural': `Neste PC o InstallerClean não teve certeza de quais arquivos em cache pertencem aos programas instalados aqui, então reteve {0} {1} ({2}) em vez de listá-los.`,
  'Cli.WithheldReasons.Header': `Por que não foi possível ter certeza:`,
  'Cli.WithheldReasons.RecordedPath': `  Um caminho de arquivo nos próprios registros do Windows Installer não pôde ser resolvido.`,
  'Cli.WithheldReasons.FileIdentity': `  A identidade de um arquivo citado nos registros do Windows Installer não pôde ser lida.`,
  'Cli.WithheldReasons.SecondInstance': `  Um programa pode estar instalado mais de uma vez neste PC.`,
