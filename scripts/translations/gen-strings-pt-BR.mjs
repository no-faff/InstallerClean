...
const MAP = {
  ...
  'Body.PendingReboot.MsiExecuteMutexAccessRefused': `O Windows negou ao InstallerClean permissão para verificar se o Windows Installer está ocupado, então Mover e Excluir ficam pausados e o InstallerClean não vai tocar em {InstallerFolder}. Reinicie o Windows e use Reanalisar. Se o Windows continuar negando, este não é um computador que o InstallerClean possa limpar.`,
  ...
  'Body.RegisteredMissingFromDisk': `Este arquivo de instalação está faltando. Agora não causa problema nenhum, e não vai causar até o dia em que você tentar atualizar ou desinstalar o programa a que ele pertence. Essa etapa pode falhar então, porque o Windows procura este arquivo e ele não está lá.\n\nPara recolocá-lo, você precisa do instalador da versão que já tem. Consiga-o com o fabricante do programa e execute-o por cima da sua cópia atual. Uma versão mais nova não serve: ela teria que remover primeiro a que você tem, e é justamente essa etapa que precisa deste arquivo. Desinstalar primeiro também não funciona, pelo mesmo motivo. Isso deve restaurar o arquivo e deixar suas configurações intactas, mas a Microsoft não garante.`,
  ...
  'Status.MoveFailed': `{0}. Detalhes em {1}.`,
  'Status.MoveFailed.NoLog': `{0}. Não foi possível gravar o crash.log.`,
  'Status.DeleteFailed': `{0}. Detalhes em {1}.`,
  'Status.DeleteFailed.NoLog': `{0}. Não foi possível gravar o crash.log.`,
  ...
  'Completion.FailedCount.Singular': `{0} arquivo não pôde ser movido.`,
  'Completion.FailedCount.Plural': `{0} arquivos não puderam ser movidos.`,
  'Completion.FailedCountDelete.Singular': `{0} arquivo não pôde ser excluído.`,
  'Completion.FailedCountDelete.Plural': `{0} arquivos não puderam ser excluídos.`,
  ...
  'Summary.NothingListed.Singular': `O InstallerClean não conseguiu ter certeza de quais arquivos em cache pertencem aos programas instalados aqui, então reteve o único arquivo em vez de oferecê-lo.`,
  'Summary.NothingListed.Plural': `O InstallerClean não conseguiu ter certeza de quais arquivos em cache pertencem aos programas instalados aqui, então reteve {0} {1} em vez de oferecê-los.`,
  'Summary.MissingFromDisk.Singular': `O Windows tem um registro de {0} arquivo que não está em {InstallerFolder}: {1}. No dia a dia não causa problema, mas uma atualização ou desinstalação desse programa pode falhar. Abra Detalhes para saber o que fazer.`,
  'Summary.MissingFromDisk.Plural': `O Windows tem registros de {0} arquivos que não estão em {InstallerFolder}: {1}. No dia a dia não causam problema, mas uma atualização ou desinstalação desses programas pode falhar. Abra Detalhes para saber o que fazer.`,
  ...
  'Error.StoppedTitle': `O InstallerClean parou`,
  ...
  'UpdateCheck.Failed.Unknown': `A verificação falhou por um motivo desconhecido. Os detalhes estão em {0}, se você precisar relatar o problema.`,

  // 0 = the URL the user was trying to reach
  'BrowserLaunch.ClipboardOk': `O link está na área de transferência, então você pode colá-lo:&#10;&#10;{0}`,
  'BrowserLaunch.ClipboardFailed': `O InstallerClean também não conseguiu copiar o link para a área de transferência, então aqui está:&#10;&#10;{0}`,
  ...
  'Startup.AlreadyRunningTitle': `InstallerClean`,
  'Startup.AlreadyRunningBody': `Já está em execução.`,
  'Startup.UnhandledTitle': `InstallerClean`,
  ...
  'Completion.MoveCancelledSummary': `Movimentação cancelada após mover {0} de {1} {2} para {3}.`,
  ...
  'Tooltip.MoveSameDrive': `Move os arquivos desnecessários para a pasta de backup. Ela está na mesma unidade, então você só recupera o espaço depois de excluir essa pasta.`,
  'Confirm.DeletePermanently.Singular': `Este arquivo será excluído permanentemente. É seguro fazer isso, mas se você quiser uma cópia, use Mover.`,
  'Confirm.DeletePermanently.Plural': `Estes arquivos serão excluídos permanentemente. É seguro fazer isso, mas se você quiser uma cópia, use Mover.`,
  ...
  'Error.ScanInstallerFolderElsewhere': `O InstallerClean não pode analisar {InstallerFolder} neste PC. O Windows informa essa pasta como {0}, e o InstallerClean só analisa uma pasta Installer que o Windows informe em seu próprio caminho. Nada foi oferecido e nada foi removido.`,
  'Completion.NothingOffered': `Nada oferecido neste PC`,
  'Completion.NothingOfferedBody.Singular': `O InstallerClean não conseguiu ter certeza de quais arquivos em cache pertencem aos programas instalados aqui, então reteve o único arquivo ({2}) em vez de oferecê-lo.`,
  'Completion.NothingOfferedBody.Plural': `O InstallerClean não conseguiu ter certeza de quais arquivos em cache pertencem aos programas instalados aqui, então reteve todos os {0} {1} ({2}) em vez de oferecê-los.`,
  'Summary.SupersededHeldBack.Singular': `O InstallerClean não conseguiu ter certeza de que o único arquivo substituído não é mais necessário, então o reteve.`,
  'Summary.SupersededHeldBack.Plural': `O InstallerClean não conseguiu ter certeza de que {0} arquivos substituídos não são mais necessários, então os reteve.`,
  'Cli.SupersededHeldBack.Singular': `O InstallerClean não conseguiu ter certeza de que o único arquivo substituído não é mais necessário, então o reteve.`,
  'Cli.SupersededHeldBack.Plural': `O InstallerClean não conseguiu ter certeza de que {0} arquivos substituídos não são mais necessários, então os reteve.`,
  'Completion.HeldBack.Singular': `{0} arquivo retido. A análise disse que ele não era necessário. A verificação final não pôde confirmar isso.`,
  'Completion.HeldBack.Plural': `{0} arquivos retidos. A análise disse que eles não eram necessários. A verificação final não pôde confirmar isso.`,
  'Body.PendingReboot.PendingRenameUnresolved': `Há uma operação de arquivos na fila para a próxima reinicialização e o InstallerClean não consegue saber quais arquivos ela nomeia, então não dá para descartar que estejam em {InstallerFolder}. Reinicie o Windows antes de limpar.`,
  'Completion.MoveRestoreHint': `Exclua essa pasta quando estiver convencido de que está tudo bem.`,
  'Completion.MoveRestoreHintSameDrive': `Exclua essa pasta quando estiver convencido de que está tudo bem. Só então o espaço é realmente recuperado.`,
  'Confirm.MoveDestination.Singular': `Este arquivo será movido para:`,
  'Confirm.MoveDestination.Plural': `Estes arquivos serão movidos para:`,
  'Cli.NothingListed.Singular': `O InstallerClean não conseguiu ter certeza de quais arquivos em cache pertencem aos programas instalados aqui, então reteve o único arquivo ({2}) em vez de oferecê-lo.`,
  'Cli.NothingListed.Plural': `O InstallerClean não conseguiu ter certeza de quais arquivos em cache pertencem aos programas instalados aqui, então reteve {0} {1} ({2}) em vez de oferecê-los.`,
  'Cli.WithheldReasons.Header': `Por que não foi possível ter certeza:`,
  'Cli.WithheldReasons.RecordedPath': `  Um caminho de arquivo nos próprios registros do Windows Installer não pôde ser resolvido, então nada pôde ser associado a ele.`,
  'Cli.WithheldReasons.FileIdentity': `  Não foi possível identificar um arquivo do qual o Windows tem registro, então não foi possível compará-lo com o que há na pasta.`,
  'Cli.WithheldReasons.SecondInstance': `  Um programa pode estar instalado mais de uma vez neste PC, e os registros não conseguem dizer a qual cópia um arquivo pertence.`,
  'Cli.PendingRebootBlocked.PendingRenameUnresolved': `Erro: há uma operação de arquivos na fila para a próxima reinicialização e o InstallerClean não consegue saber quais arquivos ela nomeia, então não dá para descartar {InstallerFolder}. Reinicie o Windows antes de limpar.`,
  'Cli.MoveRestoreHint': `Confirme que seus programas ainda atualizam e desinstalam normalmente e depois exclua {0}.`,
  'Error.ScanStoppedDetails': `Isso também fica registrado em {0}.`,
  'Cli.NothingListedPerFile.Singular': `O InstallerClean não teve certeza sobre um dos arquivos em cache que encontrou, então reteve esse ({2}) em vez de oferecê-lo.`,
  'Cli.NothingListedPerFile.Plural': `O InstallerClean não teve certeza sobre alguns dos arquivos em cache que encontrou, então reteve {0} {1} ({2}) em vez de oferecê-los.`,
  'Cli.NothingOfferedPerFile.Singular': `O InstallerClean não conseguiu estabelecer que o arquivo em cache que encontrou não é necessário, então reteve esse único arquivo ({2}) em vez de oferecê-lo.`,
  'Cli.NothingOfferedPerFile.Plural': `O InstallerClean não conseguiu estabelecer de nenhum dos arquivos em cache que encontrou que não seja necessário, então reteve todos os {0} {1} ({2}) em vez de oferecê-los.`,
  'Completion.NothingOfferedPerFileBody.Singular': `O InstallerClean não conseguiu estabelecer que o arquivo em cache que encontrou não é necessário, então reteve esse único arquivo ({2}) em vez de oferecê-lo.`,
  'Completion.NothingOfferedPerFileBody.Plural': `O InstallerClean não conseguiu estabelecer de nenhum dos arquivos em cache que encontrou que não seja necessário, então reteve todos os {0} {1} ({2}) em vez de oferecê-los.`,
  'Summary.NothingListedPerFile.Singular': `O InstallerClean não teve certeza sobre um dos arquivos em cache que encontrou, então o reteve em vez de oferecê-lo.`,
  'Summary.NothingListedPerFile.Plural': `O InstallerClean não teve certeza sobre alguns dos arquivos em cache que encontrou, então reteve {0} {1} em vez de oferecê-los.`,
  ...
  'Cli.WithheldReasons.DeclaredProductUnestablished': `  Ou um arquivo não informou a qual programa pertence, ou o Windows não deu uma resposta clara sobre esse programa.`,
