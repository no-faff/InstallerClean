...
const MAP = {
  ...
  'Automation.CheckForUpdates.HelpText': `Sprawdza na stronie wydań github, czy jest nowsza wersja.`,
  ...
  'Cli.MutexBlocked': `Inny proces InstallerClean trzyma blokadę pojedynczej instancji (GUI lub inne uruchomienie CLI). Kod wyjścia 75 (stan przejściowy); można bezpiecznie spróbować ponownie później.`,
  ...
  'Cli.Help.ScanOnly': `  installerclean-cli /s          Tylko skanowanie - lista niepotrzebnych plików`,
  'Cli.Help.Delete': `  installerclean-cli /d          Usuń niepotrzebne pliki (Kosz)`,
  'Cli.Help.MoveDefault': `  installerclean-cli /m          Przenieś do zapisanej lokalizacji domyślnej`,
  ...
  'Cli.Help.ExitCodesHeader': `Kody wyjścia:`,
  'Cli.Help.ExitCodeOk': `  0   sukces: przetworzono każdy oznaczony plik`,
  'Cli.Help.ExitCodeError': `  1   błąd: nic nie przetworzono (złe argumenty, skanowanie nie powiodło się, wszystkie pliki zawiodły)`,
  'Cli.Help.ExitCodePartial': `  2   częściowo: część plików przetworzono, część zawiodła`,
  'Cli.Help.ExitCodeTransient': `  75  stan przejściowy: tymczasowy warunek zablokował uruchomienie (zob. komunikat)`,
  ...
  'Cli.Help.MoveScheduledNote': `Zapisana lokalizacja domyślna jest przypisana do użytkownika; uruchomienia zaplanowane lub na koncie SYSTEM wymagają /m ŚCIEŻKA.`,
  ...
  'Automation.About.Guide.HelpText': `Otwiera readme na github w twojej przeglądarce.`,
  'Automation.About.ReportProblem.HelpText': `Otwiera listę zgłoszeń (Issues) na github.com w twojej przeglądarce.`,
  'Automation.AutoUpdateCheck.HelpText': `Jeśli zaznaczone, InstallerClean przy uruchomieniu sprawdza na github, czy jest nowsza wersja.`,
};
