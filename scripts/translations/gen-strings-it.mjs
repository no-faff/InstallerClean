...
const MAP = {
  ...
  'Section.Backup.Folder': `DESTINAZIONE SPOSTAMENTO`,
  ...
  'Action.Move': `_Sposta`,
  'Action.BackupFolderPlaceholder': `Percorso cartella, se scegli 'Sposta' anziché 'Elimina'`,
