...
const MAP = {
  ...
  'Section.Backup.Folder': `CARTELLA DI DESTINAZIONE`,
  ...
  'Automation.Section.BackupFolder': `Cartella di destinazione`,
  'Automation.Section.Patches': `Patch`,
  'Automation.Section.ProductDetails': `Dettagli prodotto`,
  'Automation.BackupFolder': `Cartella di destinazione`,
  ...
  'Tooltip.Move': `Sposta i file non necessari nella cartella di destinazione. Elimina quella cartella quando sei convinto che a nessuno servano.`,
  'Tooltip.MoveNeedsDestination': `Sposta i file non necessari in una cartella di destinazione. La scegli subito dopo. Elimina quella cartella quando sei convinto che a nessuno servano.`,
  'Tooltip.Delete': `Elimina definitivamente i file non necessari. Sono sicuri da rimuovere e recuperi subito lo spazio.`,
  ...
  'Body.MainExplanation.Action': `Spostali in una cartella di destinazione che scegli tu, poi elimina quella cartella quando ti sei accertato che i tuoi programmi si aggiornano, si riparano e si disinstallano come sempre. Rimetterli in {InstallerFolder} ripristina tutto. Oppure eliminali definitivamente adesso.`,
  ...
  'Confirm.MoveDestination': `Sposta in:`,
  ...
  'Error.DestinationNotFullyQualified': `La cartella di destinazione deve essere un percorso completo a una cartella, che inizia con una lettera di unità o una condivisione di rete (ad esempio D:\\Backup, oppure \\\\server\\backup). InstallerClean non può usare questo: {0}`,
  ...
  'Error.DestinationChangedMidBatch': `InstallerClean non è più riuscito a confermare la cartella di destinazione, quindi si è fermato anziché scrivere nel posto sbagliato. Controlla {0}, poi Ripeti scansione e riprova.`,
  ...
  'Cli.GenericError': `Errore: guasto inatteso ({0}). Dettagli scritti in {1}.`,
  'Cli.GenericError.NoLog': `Errore: guasto inatteso ({0}). Non è stato possibile scrivere il registro dei crash.`,
  ...
  'Cli.Help.MoveScheduledNote': `La cartella è per utente; le esecuzioni pianificate usano /m PERCORSO.`,
  ...
  'Tooltip.MoveSameDrive': `Sposta i file non necessari nella cartella di destinazione. È sulla stessa unità, quindi non recuperi lo spazio finché non elimini quella cartella o non la sposti su un'altra unità. Puoi farlo quando sei convinto che a nessuno servano.`,
  'Completion.MoveRestoreHint.Singular': `Il file in quella cartella è [sicuro da rimuovere], quindi elimina la cartella quando vuoi. Fino ad allora puoi rimetterlo in {InstallerFolder} se un programma dovesse mai averne bisogno (estremamente improbabile).`,
  'Completion.MoveRestoreHint.Plural': `I file in quella cartella sono [sicuri da rimuovere], quindi eliminala quando vuoi. Fino ad allora puoi rimetterli in {InstallerFolder} se un programma dovesse mai averne bisogno di uno (estremamente improbabile).`,
  'Completion.MoveRestoreHintSameDrive.Singular': `Il file in quella cartella è [sicuro da rimuovere], quindi elimina la cartella o spostala su un'altra unità quando vuoi davvero recuperare lo spazio. Fino ad allora puoi rimetterlo in {InstallerFolder} se un programma dovesse mai averne bisogno (estremamente improbabile).`,
  'Completion.MoveRestoreHintSameDrive.Plural': `I file in quella cartella sono [sicuri da rimuovere], quindi eliminala o spostala su un'altra unità quando vuoi davvero recuperare lo spazio. Fino ad allora puoi rimetterli in {InstallerFolder} se un programma dovesse mai averne bisogno di uno (estremamente improbabile).`,
  'Confirm.DeletePermanently.Singular': `Questo file verrà eliminato definitivamente. È [sicuro da eliminare], ma se vuoi una copia di riserva usa invece il pulsante Sposta.`,
  'Confirm.DeletePermanently.Plural': `I file verranno eliminati definitivamente. Sono [sicuri da eliminare], ma se vuoi una copia di riserva usa invece il pulsante Sposta.`,
  ...
  'Cli.MissingFromDisk.Singular': `Windows ha un record per {0} file che non si trova in {InstallerFolder}: {1}. Nell'uso quotidiano non crea problemi, ma una riparazione, un aggiornamento o una disinstallazione possono non riuscire a causa sua. Rieseguire il programma di installazione di quel software, preferibilmente nella stessa versione, di solito ripristina il file.`,
