...
const MAP = {
  ...
  'Cli.DestinationChangedMidBatch': `InstallerClean non è più riuscito a confermare la cartella di backup, quindi si è fermato anziché scrivere nel posto sbagliato. Controlla {0}, poi esegui di nuovo il comando.`,
  ...
  'Summary.SupersededHeldBack.Singular': `Su questo PC InstallerClean non è riuscito a stabilire con certezza che l'unico file sostituito non serva più, perciò l'ha trattenuto.`,
  'Summary.SupersededHeldBack.Plural': `Su questo PC InstallerClean non è riuscito a stabilire con certezza che {0} file sostituiti non servano più, perciò li ha trattenuti.`,
  'Cli.SupersededHeldBack.Singular': `Su questo PC InstallerClean non è riuscito a stabilire con certezza che l'unico file sostituito non serva più, perciò l'ha trattenuto.`,
  'Cli.SupersededHeldBack.Plural': `Su questo PC InstallerClean non è riuscito a stabilire con certezza che {0} file sostituiti non servano più, perciò li ha trattenuti.`,
  'Completion.HeldBack.Singular': `{0} file trattenuto. La scansione lo dava per non necessario. Il controllo finale non è stato d'accordo.`,
  'Completion.HeldBack.Plural': `{0} file trattenuti. La scansione li dava per non necessari. Il controllo finale non è stato d'accordo.`,
  ...
  'Cli.NothingListed.Singular': `Su questo PC InstallerClean non è riuscito a stabilire con certezza quali file nella cache appartengono ai programmi installati qui, quindi ha trattenuto l'unico file ({2}) invece di elencarlo.`,
  'Cli.NothingListed.Plural': `Su questo PC InstallerClean non è riuscito a stabilire con certezza quali file nella cache appartengono ai programmi installati qui, quindi ha trattenuto {0} {1} ({2}) invece di elencarli.`,
  'Cli.WithheldReasons.Header': `Perché non è stato possibile averne certezza:`,
  'Cli.WithheldReasons.RecordedPath': `  Un percorso di file negli archivi di Windows Installer non si è risolto.`,
  'Cli.WithheldReasons.FileIdentity': `  L'identità di un file citato negli archivi di Windows Installer non si è letta.`,
  'Cli.WithheldReasons.SecondInstance': `  Un programma potrebbe essere installato più di una volta su questo PC.`,
