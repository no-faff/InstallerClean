...
const MAP = {
  ...
  'Automation.RecycleUnavailableMove': `Sposta i file non necessari in una specifica cartella`,
  ...
  'Automation.CheckForUpdates.HelpText': `Verifica in pagina release di github se esiste una versione più recente.`,
  ...
  'Cli.Help.Help': `  installerclean-cli --help       Mostra questa guida (accetta anche /?, -h)`,
  'Cli.Help.Version': `  installerclean-cli --version    Mostra la versione (accetta anche -v)`,
  'Cli.Help.ScanOnly': `  installerclean-cli /s           Solo scansione - elenca i file non necessari`,
  'Cli.Help.Delete': `  installerclean-cli /d           Elimina i file non necessari (Cestino)`,
  'Cli.Help.MoveDefault': `  installerclean-cli /m           Sposta nella destinazione predefinita salvata`,
  ...
  'Cli.Help.ExitCodeError': `  1   errore: nessuna elaborazione (argomenti errati, scansione non riuscita, tutti i file non riusciti)`,
  'Cli.Help.ExitCodePartial': `  2   parziale: alcuni file elaborati, altri non riusciti`,
  'Cli.Help.ExitCodeTransient': `  75  transitorio: una condizione temporanea ha bloccato l'esecuzione (vedi il messaggio)`,
  ...
  'Cli.Help.MoveScheduledNote': `La destinazione predefinita salvata è specifica per utente; le esecuzioni pianificate o come SYSTEM richiedono /m PERCORSO.`,
  ...
  'About.AutoUpdateCheck': `Controlla aggiornamenti automaticamente`,
  'Automation.About.Guide.HelpText': `Apre readme in github nel browser.`,
  'Automation.About.ReportProblem.HelpText': `Apre elenco problemi (issue) in github.com nel browser.`,
  'Automation.AutoUpdateCheck.HelpText': `Se selezionata, InstallerClean verifica in github se è disponibile una versione più recente all'avvio.`,
};
