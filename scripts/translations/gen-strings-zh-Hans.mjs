...
const MAP = {
  ...
  'Summary.SupersededHeldBack.Singular': `在这台电脑上，InstallerClean 无法确定唯一那个被取代的文件已不再需要，因此保留了它。`,
  'Summary.SupersededHeldBack.Plural': `在这台电脑上，InstallerClean 无法确定 {0} 个被取代的文件已不再需要，因此保留了它们。`,
  'Cli.SupersededHeldBack.Singular': `在这台电脑上，InstallerClean 无法确定唯一那个被取代的文件已不再需要，因此保留了它。`,
  'Cli.SupersededHeldBack.Plural': `在这台电脑上，InstallerClean 无法确定 {0} 个被取代的文件已不再需要，因此保留了它们。`,
  'Completion.HeldBack.Singular': `已保留 {0} 个文件。扫描认为它不需要，最终检查却不这么认为。`,
  'Completion.HeldBack.Plural': `已保留 {0} 个文件。扫描认为它们不需要，最终检查却不这么认为。`,
  ...
  'Cli.NothingListed.Singular': `在这台电脑上，InstallerClean 无法确定缓存中哪些文件属于这里安装的程序，因此保留了这个文件（{2}），没有把它列出。`,
  'Cli.NothingListed.Plural': `在这台电脑上，InstallerClean 无法确定缓存中哪些文件属于这里安装的程序，因此保留了 {0} {1}（{2}），没有把它们列出。`,
  'Cli.WithheldReasons.Header': `无法确定的原因：`,
  'Cli.WithheldReasons.RecordedPath': `  Windows Installer 自身记录中的一个文件路径无法解析。`,
  'Cli.WithheldReasons.FileIdentity': `  无法读取 Windows Installer 记录中所列某个文件的标识。`,
  'Cli.WithheldReasons.SecondInstance': `  某个程序可能在这台电脑上安装了不止一次。`,
