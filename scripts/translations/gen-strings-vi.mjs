...
const MAP = {
  ...
  'Section.Move.Location': `NƠI CHUYỂN ĐẾN`,
  ...
  'Summary.MissingFromDisk.Plural': `{0} tệp đã đăng ký bị thiếu (không phải do InstallerClean xóa). Hiện chưa có vấn đề, nhưng một lần sửa chữa, cập nhật hoặc gỡ cài đặt chương trình liên quan trong tương lai có thể thất bại. Mở Chi tiết để biết cần làm gì.`,
  ...
  'Error.DestinationInSystemFolder': `Đích {0} nằm dưới một thư mục hệ thống của Windows. Hãy chọn một đường dẫn ngoài %SystemRoot%, %ProgramFiles% và %ProgramData%.`,
  ...
  'Cli.UnknownArgument': `Đối số không xác định: '{0}'`,
  'Cli.Cancelling': `Đang hủy...`,
  'Cli.Cancelled': `Đã hủy.`,
  'Cli.GenericError': `Lỗi: {0}. Chi tiết đã ghi vào {1}.`,
  'Cli.GenericError.NoLog': `Lỗi: {0}. Không thể ghi nhật ký sự cố.`,
  ...
  'Cli.Help.Help': `  installerclean-cli --help        Hiển thị trợ giúp này (cũng nhận /?, -h)`,
  'Cli.Help.Version': `  installerclean-cli --version     In ra phiên bản (cũng nhận -v)`,
  'Cli.Help.ScanOnly': `  installerclean-cli /s            Chỉ quét - liệt kê các tệp không cần thiết`,
  ...
  'Cli.Help.NoteLine3': `với mọi tệp console khác. GUI nằm trong InstallerClean.exe cùng chỗ.`,
  'Cli.Help.ExitCodesHeader': `Mã thoát:`,
  'Cli.Help.ExitCodeOk': `  0   thành công: mọi tệp được đánh dấu đều đã được xử lý`,
  'Cli.Help.ExitCodeError': `  1   thất bại: không xử lý được gì (sai đối số, quét thất bại, mọi tệp đều thất bại)`,
  ...
  'Cli.Help.MoveScheduledNote': `Mặc định đã lưu là theo từng người dùng; các lần chạy theo lịch hoặc bằng tài khoản SYSTEM cần /m ĐƯỜNG_DẪN.`,
