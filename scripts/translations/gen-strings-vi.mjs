...
const MAP = {
  ...
  'Summary.SupersededHeldBack.Singular': `Trên máy này, InstallerClean không thể chắc chắn rằng tệp bị thay thế duy nhất đó không còn cần đến nữa, nên đã giữ lại nó.`,
  'Summary.SupersededHeldBack.Plural': `Trên máy này, InstallerClean không thể chắc chắn rằng {0} tệp bị thay thế không còn cần đến nữa, nên đã giữ lại chúng.`,
  'Cli.SupersededHeldBack.Singular': `Trên máy này, InstallerClean không thể chắc chắn rằng tệp bị thay thế duy nhất đó không còn cần đến nữa, nên đã giữ lại nó.`,
  'Cli.SupersededHeldBack.Plural': `Trên máy này, InstallerClean không thể chắc chắn rằng {0} tệp bị thay thế không còn cần đến nữa, nên đã giữ lại chúng.`,
  'Completion.HeldBack.Singular': `Đã giữ lại {0} tệp. Lần quét cho rằng nó không cần thiết. Lần kiểm tra cuối không đồng ý.`,
  'Completion.HeldBack.Plural': `Đã giữ lại {0} tệp. Lần quét cho rằng chúng không cần thiết. Lần kiểm tra cuối không đồng ý.`,
  ...
  'Cli.NothingListed.Singular': `Trên máy này InstallerClean không thể chắc chắn những tệp nào trong bộ nhớ đệm thuộc về các chương trình đã cài ở đây, nên đã giữ lại tệp duy nhất ({2}) thay vì liệt kê nó.`,
  'Cli.NothingListed.Plural': `Trên máy này InstallerClean không thể chắc chắn những tệp nào trong bộ nhớ đệm thuộc về các chương trình đã cài ở đây, nên đã giữ lại {0} {1} ({2}) thay vì liệt kê chúng.`,
  'Cli.WithheldReasons.Header': `Vì sao không thể chắc chắn:`,
  'Cli.WithheldReasons.RecordedPath': `  Một đường dẫn tệp trong chính hồ sơ của Windows Installer không phân giải được.`,
  'Cli.WithheldReasons.FileIdentity': `  Không đọc được danh tính của một tệp được nêu tên trong hồ sơ của Windows Installer.`,
  'Cli.WithheldReasons.SecondInstance': `  Một chương trình có thể đã được cài nhiều hơn một lần trên máy này.`,
