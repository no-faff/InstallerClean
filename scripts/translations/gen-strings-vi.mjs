...
const MAP = {
  ...
  'Error.StoppedTitle': `InstallerClean đã dừng`,
  ...
  'Completion.MoveCancelledSummary': `Đã chuyển {0}/{1} {2} tới {3} trước khi bạn hủy.`,
  ...
  'Error.ScanInstallerFolderElsewhere': `InstallerClean không thể quét {InstallerFolder} trên máy này. Windows báo thư mục đó là {0}, và InstallerClean chỉ quét một thư mục Installer mà Windows báo đúng ở đường dẫn của chính nó. Không có gì được đề xuất và không có gì bị bỏ đi.`,
  ...
  'Cli.MoveInstallerLockAccessRefused': `Lỗi: Windows đã từ chối cho InstallerClean quyền kiểm tra xem Windows Installer có đang bận không, nên nó không thể loại trừ khả năng một tệp trở nên cần thiết giữa chừng. Không có gì được chuyển.`,
  'Cli.PendingRebootBlocked.RegistryCheckUnreadable': `Lỗi: InstallerClean không đọc được một trong các giá trị registry mà nó kiểm tra trước khi đụng vào {InstallerFolder}, nên không thể loại trừ một thao tác Windows Installer đang chạy hoặc đang xếp hàng chờ lần khởi động lại tới. /m và /d bị chặn. Hãy khởi động lại Windows rồi thử lại. Nếu vẫn không đọc được thì đây không phải máy mà InstallerClean có thể dọn.`,
  'Completion.MoveCancelledRestoreHint': `Hoàn tác rất đơn giản. Hãy chuyển chúng trở lại {InstallerFolder} và mọi thứ sẽ như cũ.`,
  'Error.InstallerLockAccessRefused': `Windows đã từ chối cho InstallerClean quyền kiểm tra xem Windows Installer có đang bận không, nên nó không thể loại trừ khả năng một tệp trở nên cần thiết giữa chừng, và không có gì bị xóa.`,
  'Error.MoveInstallerLockAccessRefused': `Windows đã từ chối cho InstallerClean quyền kiểm tra xem Windows Installer có đang bận không, nên nó không thể loại trừ khả năng một tệp trở nên cần thiết giữa chừng, và không có gì được chuyển.`,
  'Error.MoveStoppedTitle': `Đã dừng chuyển`,
  'Field.NoNamedProduct': `(không có chương trình)`,
