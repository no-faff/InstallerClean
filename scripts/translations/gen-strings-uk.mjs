...
const OVERRIDES = {
  ...
  'Completion.HeldBack.Few': `Затримано {0} файли. Сканування вважало їх непотрібними. Підсумкова перевірка не погодилася.`,
  ...
  'Summary.SupersededHeldBack.Few': `На цьому ПК InstallerClean не зміг упевнено визначити, що {0} заміщені файли більше не потрібні, тож затримав їх.`,
  'Cli.SupersededHeldBack.Few': `На цьому ПК InstallerClean не зміг упевнено визначити, що {0} заміщені файли більше не потрібні, тож затримав їх.`,
};
...
const MAP = {
  ...
  'Summary.SupersededHeldBack.Singular': `На цьому ПК InstallerClean не зміг упевнено визначити, що єдиний заміщений файл більше не потрібен, тож затримав його.`,
  'Summary.SupersededHeldBack.Plural': `На цьому ПК InstallerClean не зміг упевнено визначити, що {0} заміщених файлів більше не потрібні, тож затримав їх.`,
  'Cli.SupersededHeldBack.Singular': `На цьому ПК InstallerClean не зміг упевнено визначити, що єдиний заміщений файл більше не потрібен, тож затримав його.`,
  'Cli.SupersededHeldBack.Plural': `На цьому ПК InstallerClean не зміг упевнено визначити, що {0} заміщених файлів більше не потрібні, тож затримав їх.`,
  'Completion.HeldBack.Singular': `Затримано {0} файл. Сканування вважало його непотрібним. Підсумкова перевірка не погодилася.`,
  'Completion.HeldBack.Plural': `Затримано {0} файлів. Сканування вважало їх непотрібними. Підсумкова перевірка не погодилася.`,
  ...
  'Cli.NothingListed.Singular': `На цьому ПК InstallerClean не зміг упевнено визначити, які файли в кеші належать встановленим тут програмам, тож затримав єдиний файл ({2}), а не вніс його до списку.`,
  'Cli.NothingListed.Plural': `На цьому ПК InstallerClean не зміг упевнено визначити, які файли в кеші належать встановленим тут програмам, тож затримав {0} {1} ({2}), а не вніс їх до списку.`,
  'Cli.WithheldReasons.Header': `Чому впевненості не було:`,
  'Cli.WithheldReasons.RecordedPath': `  Шлях до файлу з власних записів Windows Installer не вдалося розв'язати.`,
  'Cli.WithheldReasons.FileIdentity': `  Ідентичність файлу, названого в записах Windows Installer, не вдалося прочитати.`,
  'Cli.WithheldReasons.SecondInstance': `  Програму може бути встановлено на цьому ПК більше одного разу.`,
