...
const MAP = {
  ...
  'Section.Move.Location': `TAŞIMA KONUMU`,
  ...
  'Action.Browse': `_Gözat...`,
  'Action.Cancel': `_İptal`,
  'Action.CheckForUpdates': `Güncellemeleri _denetle`,
  'Action.Close': `_Kapat`,
  'Action.Delete': `_Sil`,
  ...
  'Action.Move': `_Taşı`,
  'Action.MoveInstead': `Bunun yerine _taşı`,
  'Action.MoveDestinationPlaceholder': `Silmek yerine taşıyacaksanız klasör yolu`,
  ...
  'Automation.RecycleUnavailable': `Gereksiz dosyaları nasıl ele alacağınızı seçin: güvenli bir yere taşıyın, kalıcı olarak silin ya da iptal edin.`,
  'Automation.RecycleUnavailableMove': `Gereksiz dosyaları seçtiğiniz bir klasöre taşı`,
  'Automation.RecycleUnavailableDeletePermanently': `Bu sürücü için Geri Dönüşüm Kutusu kullanılamadığından gereksiz dosyaları kalıcı olarak sil`,
  ...
  'Automation.CheckForUpdates': `Güncellemeleri denetle`,
  ...
  'Body.RegisteredMissingFromDisk': `Bu yükleyici dosyası silinmiş. Bunu InstallerClean yapmadı; bir programın hâlâ ihtiyaç duyduğu bir dosyayı asla kaldırmaz; bunu, siz InstallerClean'i çalıştırmadan önce başka bir şey silmiş.&#10;&#10;Şu anda bir soruna yol açmaz ve ait olduğu programı onarmaya, güncellemeye ya da kaldırmaya çalıştığınız güne kadar da açmaz. O adım o zaman başarısız olabilir, çünkü Windows bu dosyayı arar ama bulamaz.&#10;&#10;Düzeltmeyi denemek için o programın yükleyicisini üreticisinden indirin ve mevcut kopyanızın üzerine çalıştırın (önce kaldırmayın; kaldırma işlemi de bu dosyaya ihtiyaç duyan bir adımdır). Bulabiliyorsanız kurulu olan sürümü kullanın, çünkü Windows farklı bir sürümü reddedebilir. Bu genellikle dosyayı geri yükler ve ayarlarınıza normalde dokunulmaz, ama Microsoft bunu garanti etmez; onun son çaresi programı, hatta Windows'un kendisini yeniden yüklemektir.`,
  ...
  'Status.Moving': `{0} {1} taşınıyor...`,
  'Status.Deleting': `{0} {1} siliniyor...`,
  ...
  'Completion.MoveRestoreHint': `Bir gün bir şey bozulursa onları {InstallerFolder} içine geri kopyalayın ([ihtimali son derece düşük]).`,
  'Completion.DeleteRestoreHint': `O zamana kadar, bir gün bir şey bozulursa onları geri yükleyebilirsiniz ([ihtimali son derece düşük]).`,
  ...
  'Completion.DeleteSummary.Singular': `{0} {1} Geri Dönüşüm Kutusu'na taşındı`,
  'Completion.DeleteSummary.Plural': `{0} {1} Geri Dönüşüm Kutusu'na taşındı`,
  ...
  'Summary.MissingFromDisk.Singular': `{0} kayıtlı dosya eksik (InstallerClean tarafından silinmedi). Şu anda bir sorun yok, ama ileride bir onarma, güncelleme ya da kaldırma işlemi başarısız olabilir. Ne yapılacağını öğrenmek için Ayrıntılar'ı açın.`,
  'Summary.MissingFromDisk.Plural': `{0} kayıtlı dosya eksik (InstallerClean tarafından silinmedi). Şu anda bir sorun yok, ama ileride bir onarma, güncelleme ya da kaldırma işlemi başarısız olabilir. Ne yapılacağını öğrenmek için Ayrıntılar'ı açın.`,
  ...
  'Confirm.DeleteToRecycleBin': `Dosyalar Geri Dönüşüm Kutusu'na taşınacak. Yedek kopya isterseniz bunun yerine Taşı düğmesini kullanın.`,
  ...
  'Error.MsiNonSuccess': `Windows Installer, InstallerClean'e kurulu programların okunabilir bir listesini veremedi: arka arkaya {0} kayıt okunamaz döndü (son hata kodu {1}). InstallerClean, yalnızca kısmen okunmuş bir listeyle çalışmak yerine durdu. Hiçbir şey kaldırılmadı.`,
  ...
  'Error.DestinationInSystemFolder': `{0} hedefi bir Windows sistem klasörünün altına çözümleniyor. %SystemRoot%, %ProgramFiles% ve %ProgramData% dışında bir yol seçin.`,
...
Ayrıntılar {1} içinde.`,
  ...
  'Error.ShellRecycleFailed': `Bu dosya Geri Dönüşüm Kutusu'na taşınamadı (hata {0}) ve InstallerClean bu koda bakarak size nedenini söyleyemiyor. Dosya yerinde bırakıldı. Bunun yerine Taşı düğmesini deneyin, çünkü o Geri Dönüşüm Kutusu'nu kullanmıyor.`,
  'Error.RecycleAccessDenied': `Windows yönetici haklarıyla bile erişimi reddetti (hata {0}) ve InstallerClean sorunun dosyada mı yoksa Geri Dönüşüm Kutusu'nda mı olduğunu ayırt edemiyor. Dosya yerinde bırakıldı. Sorun Geri Dönüşüm Kutusu'ndaysa Taşı düğmesi işe yarar, ama sorun dosyadaysa yaramaz.`,
  'Error.RecycleInUse': `Bu dosya başka bir program tarafından açık ya da kilitli (hata {0}), bu yüzden şu anda onu hiçbir şey kaldıramaz. Dosya yerinde bırakıldı; daha sonra yeniden deneyin.`,
  'Error.DeletedNotRecycled': `Windows bu dosyayı Geri Dönüşüm Kutusu'na taşımak yerine doğrudan sildi. InstallerClean Geri Dönüşüm Kutusu'nu istedi, Windows ise farklı davrandı. Dosya gitti.`,
  'Error.MoveIntoInstaller': `Dosyaların Windows Installer klasörüne taşınması reddediliyor (hedef: {0}).`,
  'Error.DestinationNotFullyQualified': `Taşıma konumu, bir sürücü harfiyle ya da ağ paylaşımıyla başlayan ve bir klasöre giden tam bir yol olmalıdır (örneğin D:\\Backup ya da \\\\server\\backup). InstallerClean bunu kullanamaz: {0}`,
  'BrowserLaunch.FailedTitle': `Tarayıcınız açılamadı`,
  'UpdateCheck.Title': `Güncellemeleri denetle`,
  'UpdateCheck.Status.Checking': `Denetleniyor...`,
  'UpdateCheck.Status.UpToDate': `Güncel.`,
  'UpdateCheck.UpdateAvailable.Title': `Güncelleme mevcut`,
  ...
  'Error.DestinationChangedMidBatch': `Dosyalar taşınırken Taşıma konumu değişti (bir şey klasörü değiştirdi ya da başka bir yere yönlendirdi), bu yüzden InstallerClean yanlış yere yazmaktansa durdu. {0} konumunu kontrol edin, ardından Yeniden tara ile tekrar deneyin.`,
...
# sıralanan diğer kullanıcıların profilleri dahil). Güncelleme
...
`,
  ...
  'Cli.UnknownArgument': `Bilinmeyen argüman: '{0}'`,
  'Cli.Cancelling': `İptal ediliyor...`,
  'Cli.Cancelled': `İptal edildi.`,
  'Cli.GenericError': `Hata: {0}. Ayrıntılar {1} içine yazıldı.`,
  'Cli.GenericError.NoLog': `Hata: {0}. Çökme günlüğü yazılamadı.`,
  ...
  'Cli.RecycleUnavailable': `Hata: bu birim için Geri Dönüşüm Kutusu kullanılamıyor, bu yüzden hiçbir şey silinmedi. Dosyaları taşımak için /m kullanın ya da Geri Dönüşüm Kutusu'nu yeniden etkinleştirip tekrar çalıştırın.`,
  ...
  'Cli.Help.Delete': `  installerclean-cli /d         Gereksiz dosyaları sil (Geri Dönüşüm Kutusu)`,
  ...
  'Cli.Help.NoteLine2': `bloke eder; çıktısını başka herhangi bir konsol exe'sinde olduğu gibi`,
  'Cli.Help.NoteLine3': `yönlendirin ya da boruya verin. GUI, yanındaki InstallerClean.exe'dedir.`,
  'Cli.Help.ExitCodesHeader': `Çıkış kodları:`,
  'Cli.Help.ExitCodeOk': `  0   başarılı: işaretlenen her dosya işlendi`,
  'Cli.Help.ExitCodeError': `  1   hata: hiçbir şey işlenmedi (hatalı argümanlar, tarama başarısız, tüm dosyalar başarısız)`,
  'Cli.Help.ExitCodePartial': `  2   kısmi: bazı dosyalar işlendi, bazıları başarısız`,
  ...
  'Completion.CleanedUp': `{0} temizlendi`,
  'Completion.DeleteSpaceHint': `Alanı gerçekten geri kazanmak için onu boşaltın.`,
  ...
  'Completion.DeleteCancelledSummary': `İptal etmeden önce {1} {2} içinden {0} tanesi Geri Dönüşüm Kutusu'na taşındı.`,
  ...
  'Cli.Help.MoveScheduledNote': `Kaydedilen varsayılan kullanıcıya özeldir; zamanlanmış ya da SYSTEM çalıştırmaları /m YOL gerektirir.`,
  ...
  'Error.MsiEnumerationNeverEnded': `Windows Installer, kurulu programlar listesinin sonunu hiç bildirmedi: InstallerClean {0} kayıttan sonra vazgeçti (son hata kodu {1}). Sonu gelmeyen bir listeye güvenilemez, bu yüzden InstallerClean durdu. Hiçbir şey kaldırılmadı.`,
  ...
  'Status.CheckingRecycleBin': `Geri Dönüşüm Kutusu kontrol ediliyor...`,
  ...
  'About.AutoUpdateCheck': `Güncellemeleri otomatik olarak denetle`,
