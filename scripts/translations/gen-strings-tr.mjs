...
{1}`,
  ...
  'Cli.NothingOffered.Plural': `InstallerClean, önbellekteki dosyalardan hangisinin buradaki yüklü programlara ait olduğundan emin olamadı, bu yüzden sunabileceği {0} {1} ({2}) geri tutuldu.`,
