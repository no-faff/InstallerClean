...
const MAP = {
  ...
  'Section.Backup.Folder': `HEDEF KLASÖR`,
  ...
  'Tooltip.Move': `Gereksiz dosyaları hedef klasöre taşır. Hiçbir şeyin onlara ihtiyacı olmadığına kanaat getirdiğinizde o klasörü silin.`,
  'Tooltip.MoveNeedsDestination': `Gereksiz dosyaları bir hedef klasöre taşır. Klasörü hemen ardından seçeceksiniz. Hiçbir şeyin onlara ihtiyacı olmadığına kanaat getirdiğinizde o klasörü silin.`,
  'Tooltip.Delete': `Gereksiz dosyaları kalıcı olarak siler. Güvenle kaldırılabilirler ve yeri hemen geri kazanırsınız.`,
  ...
  'Body.MainExplanation.Action': `Onları seçeceğiniz bir hedef klasöre taşıyın, programlarınızın her zamanki gibi güncellendiğinden, onarıldığından ve kaldırılabildiğinden emin olunca da o klasörü silin. Onları {InstallerFolder} içine geri koymak her şeyi eski haline getirir. Ya da şimdi kalıcı olarak silin.`,
  ...
  'Confirm.MoveDestination': `Şuraya taşı:`,
...
Ayrıntılar {1} içinde.`,
  ...
  'Error.DestinationNotFullyQualified': `Hedef klasör, bir sürücü harfi ya da ağ paylaşımıyla başlayan, bir klasöre giden tam bir yol olmalıdır (örneğin D:\\Backup ya da \\\\sunucu\\backup). InstallerClean bunu kullanamaz: {0}`,
  ...
  'Error.DestinationChangedMidBatch': `InstallerClean hedef klasörü artık doğrulayamadı, bu yüzden yanlış yere yazmak yerine durdu. {0} konumunu denetleyin, sonra Yeniden tara deyip tekrar deneyin.`,
...
{1}`,
  ...
  'Cli.Help.MoveDefault': `  installerclean-cli /m         Kayıtlı hedef klasöre taşı`,
  ...
  'Cli.Help.MoveScheduledNote': `Klasör kullanıcıya özel kaydedilir; zamanlanmış çalıştırma /m YOL ister.`,
  ...
  'Tooltip.MoveSameDrive': `Gereksiz dosyaları hedef klasöre taşır. Klasör aynı sürücüde olduğu için, onu silene ya da başka bir sürücüye taşıyana kadar yeri geri kazanamazsınız. Bunu, hiçbir şeyin onlara ihtiyacı olmadığına kanaat getirdiğinizde yapabilirsiniz.`,
  'Completion.MoveRestoreHint.Singular': `O klasördeki dosya [güvenle kaldırılabilir], yani klasörü istediğiniz zaman silin. O zamana dek, bir program gerçekten ihtiyaç duyarsa dosyayı {InstallerFolder} içine geri koyabilirsiniz (son derece düşük bir ihtimal).`,
  'Completion.MoveRestoreHint.Plural': `O klasördeki dosyalar [güvenle kaldırılabilir], yani klasörü istediğiniz zaman silin. O zamana dek, bir program gerçekten birine ihtiyaç duyarsa dosyaları {InstallerFolder} içine geri koyabilirsiniz (son derece düşük bir ihtimal).`,
  'Completion.MoveRestoreHintSameDrive.Singular': `O klasördeki dosya [güvenle kaldırılabilir], yani yeri gerçekten geri kazanmak istediğinizde klasörü silin ya da başka bir sürücüye taşıyın. O zamana dek, bir program gerçekten ihtiyaç duyarsa dosyayı {InstallerFolder} içine geri koyabilirsiniz (son derece düşük bir ihtimal).`,
  'Completion.MoveRestoreHintSameDrive.Plural': `O klasördeki dosyalar [güvenle kaldırılabilir], yani yeri gerçekten geri kazanmak istediğinizde klasörü silin ya da başka bir sürücüye taşıyın. O zamana dek, bir program gerçekten birine ihtiyaç duyarsa dosyaları {InstallerFolder} içine geri koyabilirsiniz (son derece düşük bir ihtimal).`,
  'Confirm.DeletePermanently.Singular': `Bu dosya kalıcı olarak silinecek. [Güvenle silinebilir], ama bir yedek isterseniz onun yerine Taşı düğmesini kullanın.`,
  'Confirm.DeletePermanently.Plural': `Dosyalar kalıcı olarak silinecek. [Güvenle silinebilirler], ama bir yedek isterseniz onun yerine Taşı düğmesini kullanın.`,
  ...
  'Cli.NothingOffered.Singular': `InstallerClean, önbellekteki dosyalardan hangisinin buradaki yüklü programlara ait olduğundan emin olamadı, bu yüzden sunabileceği tek dosyayı ({2}) tuttu.`,
  'Cli.NothingOffered.Plural': `InstallerClean, önbellekteki dosyalardan hangisinin buradaki yüklü programlara ait olduğundan emin olamadı, bu yüzden sunabileceği {0} {1} ({2}) tamamını tuttu.`,
  'Cli.DestinationChangedMidBatch': `InstallerClean hedef klasörü artık doğrulayamadı, bu yüzden yanlış yere yazmak yerine durdu. {0} konumunu denetleyin, sonra komutu yeniden çalıştırın.`,
  ...
  'Summary.RecordsNotMatched': `InstallerClean, Windows kayıtlarındaki her şeyi eşleştiremedi, bu yüzden hepsini okumadı. Yukarıdaki gereksiz dosyalar bundan etkilenmez, ama {InstallerFolder} içinde eksik olan dosyalar hakkında söyledikleri tam tabloyu vermiyor olabilir. Yeniden tarayarak tekrar deneyin.`,
  'Cli.RecordsNotMatched': `InstallerClean, Windows kayıtlarındaki her şeyi eşleştiremedi, bu yüzden hepsini okumadı. Bulduklarını bu etkilemez, ama {InstallerFolder} içinde eksik olan dosyalar hakkında söyledikleri tam tabloyu vermiyor olabilir. Yeniden çalıştırmak daha fazlasını bulabilir.`,
