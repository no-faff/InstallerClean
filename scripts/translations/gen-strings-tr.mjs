...
const MAP = {
  ...
  'Action.BuyMeACuppa': `_Bağış yap`,
  'Action.Donate': `Bağış yap`,
  ...
  'Automation.BuyMeACuppa.About': `Bağış yap`,
  'Automation.Donate': `Bağış yap`,
  ...
  'Tooltip.BuyMeACuppa.About': `Küçük de olsa her bağış çok makbule geçer.`,
  ...
  'Body.PendingReboot.MsiExecuteMutexAccessRefused': `Windows, InstallerClean'e Windows Installer'ın meşgul olup olmadığını denetleme izni vermedi, bu yüzden Taşı ve Sil duraklatıldı ve InstallerClean {InstallerFolder} klasörüne dokunmayacak. Windows'u yeniden başlatın ve yeniden tarayın. Windows yine reddederse, burası InstallerClean'in temizleyebileceği bir makine değil.`,
  ...
  'Completion.FailedCount.Singular': `{0} dosya taşınamadı.`,
  'Completion.FailedCount.Plural': `{0} dosya taşınamadı.`,
  'Completion.FailedCountDelete.Singular': `{0} dosya silinemedi.`,
  'Completion.FailedCountDelete.Plural': `{0} dosya silinemedi.`,
  ...
  'Error.StoppedTitle': `InstallerClean durdu`,
...
Ayrıntılar {1} içinde.`,
  ...
  'BrowserLaunch.ClipboardOk': `Bağlantı panoda, yani kendiniz yapıştırabilirsiniz:&#10;&#10;{0}`,
  'BrowserLaunch.ClipboardFailed': `InstallerClean bağlantıyı panoya da kopyalayamadı, işte burada:&#10;&#10;{0}`,
...
{1}`,
  ...
  'Completion.DonateAsk': `Küçük de olsa her bağış çok makbule geçer.`,
  ...
  'Error.ScanInstallerFolderElsewhere': `InstallerClean bu bilgisayarda {InstallerFolder} klasörünü tarayamıyor. Windows bu klasörü {0} olarak bildiriyor ve InstallerClean yalnızca, Windows'un klasörün kendi yolunda bildirdiği bir Installer klasörünü tarar. Hiçbir şey sunulmadı ve hiçbir şey kaldırılmadı.`,
  ...
  'Completion.NothingOfferedBody.Plural': `InstallerClean, önbellekteki dosyalardan hangisinin buradaki yüklü programlara ait olduğundan emin olamadı, bu yüzden tüm {0} {1} ({2}) sunulmak yerine geri tutuldu.`,
  ...
  'Cli.NothingListed.Plural': `InstallerClean, önbellekteki dosyalardan hangisinin buradaki yüklü programlara ait olduğundan emin olamadı, bu yüzden {0} {1} ({2}) sunulmak yerine geri tutuldu.`,
  ...
  'Cli.NothingListedPerFile.Plural': `InstallerClean, bulduğu önbellek dosyalarından bazıları hakkında emin olamadı, bu yüzden {0} {1} ({2}) sunulmak yerine geri tutuldu.`,
  ...
  'Cli.NothingOfferedPerFile.Plural': `InstallerClean, bulduğu önbellek dosyalarının hiçbirinin gereksiz olduğunu saptayamadı, bu yüzden tüm {0} {1} ({2}) sunulmak yerine geri tutuldu.`,
  ...
  'Completion.NothingOfferedPerFileBody.Plural': `InstallerClean, bulduğu önbellek dosyalarının hiçbirinin gereksiz olduğunu saptayamadı, bu yüzden tüm {0} {1} ({2}) sunulmak yerine geri tutuldu.`,
  ...
  'Cli.MoveInstallerLockAccessRefused': `Hata: Windows, InstallerClean'e Windows Installer'ın meşgul olup olmadığını denetleme izni vermedi, bu yüzden işlem sürerken bir dosyanın gerekli hale gelmesini dışlayamadı. Hiçbir şey taşınmadı.`,
  'Cli.PendingRebootBlocked.RegistryCheckUnreadable': `Hata: InstallerClean, {InstallerFolder} klasörüne dokunmadan önce denetlediği kayıt defteri değerlerinden birini okuyamadı, bu yüzden sürmekte olan ya da bir sonraki yeniden başlatma için sıraya alınmış bir Windows Installer işlemini dışlayamıyor. /m ve /d engellendi. Windows'u yeniden başlatın ve tekrar deneyin. Okuma yine başarısız olursa, burası InstallerClean'in temizleyebileceği bir makine değil.`,
  'Completion.MoveCancelledRestoreHint': `Geri almak kolay. Onları {InstallerFolder} klasörüne geri taşıyın, her şey eskisi gibi olur.`,
  'Error.InstallerLockAccessRefused': `Windows, InstallerClean'e Windows Installer'ın meşgul olup olmadığını denetleme izni vermedi, bu yüzden işlem sürerken bir dosyanın gerekli hale gelmesini dışlayamadı ve hiçbir şey silinmedi.`,
  'Error.MoveInstallerLockAccessRefused': `Windows, InstallerClean'e Windows Installer'ın meşgul olup olmadığını denetleme izni vermedi, bu yüzden işlem sürerken bir dosyanın gerekli hale gelmesini dışlayamadı ve hiçbir şey taşınmadı.`,
  'Error.MoveStoppedTitle': `Taşıma durduruldu`,
  'Field.NoNamedProduct': `(program yok)`,
