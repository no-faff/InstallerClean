...
Ayrıntılar {1} içinde.`,
  ...
  'Error.DestinationChangedMidBatch': `InstallerClean yedek klasörünü artık doğrulayamadı, bu yüzden yanlış yere yazmak yerine durdu. {0} konumunu denetleyin, sonra Yeniden tara deyip tekrar deneyin.`,
...
{1}`,
  ...
  'Cli.DestinationChangedMidBatch': `InstallerClean yedek klasörünü artık doğrulayamadı, bu yüzden yanlış yere yazmak yerine durdu. {0} konumunu denetleyin, sonra komutu yeniden çalıştırın.`,
  ...
  'Summary.SupersededHeldBack.Singular': `Bu bilgisayarda InstallerClean, yerine geçilmiş tek dosyanın artık gerekli olmadığından emin olamadı, bu yüzden onu tuttu.`,
  'Summary.SupersededHeldBack.Plural': `Bu bilgisayarda InstallerClean, yerine geçilmiş {0} dosyanın artık gerekli olmadığından emin olamadı, bu yüzden onları tuttu.`,
  'Cli.SupersededHeldBack.Singular': `Bu bilgisayarda InstallerClean, yerine geçilmiş tek dosyanın artık gerekli olmadığından emin olamadı, bu yüzden onu tuttu.`,
  'Cli.SupersededHeldBack.Plural': `Bu bilgisayarda InstallerClean, yerine geçilmiş {0} dosyanın artık gerekli olmadığından emin olamadı, bu yüzden onları tuttu.`,
  'Completion.HeldBack.Singular': `{0} dosya geri tutuldu. Tarama bunun gereksiz olduğunu söyledi. Son denetim aynı fikirde değildi.`,
  'Completion.HeldBack.Plural': `{0} dosya geri tutuldu. Tarama bunların gereksiz olduğunu söyledi. Son denetim aynı fikirde değildi.`,
  ...
  'Cli.NothingListed.Singular': `Bu bilgisayarda InstallerClean, önbellekteki hangi dosyaların burada yüklü programlara ait olduğundan emin olamadı, bu yüzden tek dosyayı ({2}) listelemek yerine geri tuttu.`,
  'Cli.NothingListed.Plural': `Bu bilgisayarda InstallerClean, önbellekteki hangi dosyaların burada yüklü programlara ait olduğundan emin olamadı, bu yüzden {0} {1} ({2}) listelemek yerine geri tuttu.`,
  'Cli.WithheldReasons.Header': `Neden emin olunamadı:`,
  'Cli.WithheldReasons.RecordedPath': `  Windows Installer'ın kendi kayıtlarındaki bir dosya yolu çözümlenemedi.`,
  'Cli.WithheldReasons.FileIdentity': `  Windows Installer kayıtlarında adı geçen bir dosyanın kimliği okunamadı.`,
  'Cli.WithheldReasons.SecondInstance': `  Bir program bu bilgisayara birden fazla kez yüklenmiş olabilir.`,
