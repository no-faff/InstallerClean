...
| Glad to help. There's a tip jar if you're feeling kind. | Felice di esserti stato utile. Un caffè è sempre bene accetto, se ti va di essere generoso. |
...
| Close | Chiudi |
| A GitHub star helps other people find it. | Una stella su GitHub aiuta altre persone a trovare InstallerClean. |
