...
|   A file says it belongs to a program that is still installed, so it may still be needed. |   Un file dichiara di appartenere a un programma ancora installato, perciò potrebbe servire ancora. |
