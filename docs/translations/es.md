...
|   A file says it belongs to a program that is still installed, so it may still be needed. |   Un archivo dice pertenecer a un programa que sigue instalado, así que puede que aún haga falta. |
