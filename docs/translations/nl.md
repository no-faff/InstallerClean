...
| {0} {1} kept in place, because by the final check InstallerClean could not be certain which cached files belong to the programs installed here. | {0} {1} behouden, omdat InstallerClean bij de laatste controle niet met zekerheid kon vaststellen welke bestanden in de cache bij de hier geïnstalleerde programma's horen. |
