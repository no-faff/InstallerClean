...
|   A file says it belongs to a program that is still installed, so it may still be needed. |   Файл заявляет, что принадлежит программе, которая всё ещё установлена, поэтому он может быть ещё нужен. |
