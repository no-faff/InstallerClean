...
|   A file says it belongs to a program that is still installed, so it may still be needed. |   Un fichier indique appartenir à un programme toujours installé, il peut donc être encore nécessaire. |
